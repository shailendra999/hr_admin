...
if(isset($_POST["btn_del"]))
{
	...
	$sql = "delete from mpc_loan_installments where rec_id = '".$rec_id."'";
...
if(isset($_POST['install_id']))
{
	...
	$txt_installments = $_POST["txt_installments"];
	$txt_date = getdbDateSepretoe($_POST["txt_date"]);
	$installment_by = $_POST["deduction_by"];
	
	$sql_up = "update mpc_loan_installments set 
												installments = '$txt_installments',
												installment_date = '$txt_date',
												installment_by = '$installment_by' 
												where rec_id= '$install_id'";
	
	//echo $sql_up;
	$result_up = mysql_query($sql_up) or die ("Query Failed ".mysql_error());
	if($result_up)
	{
		$msg="Loan Deduction Updated!!";
	}
	else
	{
		$msg="Error In Updating Advance Loan!!";
	}
}
?>
<?
...
{			
	 $sql_prj = "select DAY(mpc_official_detail.date_joining) as 'Day',MONTH(mpc_official_detail.date_joining) as 'Month' ,YEAR(mpc_official_detail.date_joining) as 'Year',mpc_official_detail.date_joining,mpc_employee_master.rec_id as id,mpc_employee_master.ticket_no,mpc_employee_master.first_name,mpc_employee_master.last_name,mpc_official_detail.emp_id ,mpc_account_detail.emp_id,mpc_account_detail.date_releaving,mpc_loan_installments.installments,mpc_loan_installments.installment_date,mpc_loan_installments.installment_by  ,mpc_loan_installments.rec_id as install_id $select_string from ".$mysql_table_prefix."employee_master,mpc_official_detail,mpc_account_detail,mpc_loan_installments,mpc_loan_employee $table_list where mpc_employee_master.rec_id!='' and mpc_employee_master.rec_id=mpc_official_detail.emp_id and EXTRACT(YEAR_MONTH FROM mpc_official_detail.date_joining)<='$year$month' and mpc_employee_master.rec_id=mpc_account_detail.emp_id and mpc_account_detail.date_releaving ='0000-00-00' and mpc_loan_employee.emp_id = mpc_employee_master.rec_id and mpc_loan_employee.rec_id =  mpc_loan_installments.loan_id  $where_string  and  MONTH(mpc_loan_installments.installment_date)='".$month."' and YEAR(mpc_loan_installments.installment_date) ='".$year."' order by mpc_employee_master.ticket_no ASC";
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/>Loan Installment List</td>
                </tr>
                <tr>
                                                   ...
                                                   <tr>
                                                  		 <td align="right">
                                                         	<table cellpadding="0" cellspacing="0" border="0">
                                                            	<tr>
                                                                	<td>
                                                                        <form action="print_loan_installment_list.php" method="post" name="frm_print" id="frm_print" target="_blank">
                                                      ...
                                                      <div id="div_attandance_list" style="overflow:scroll;height:500px;width:1000px">
                                                            <table align="center" width="100%" cellpadding="0" cellspacing="0" class="table1" border="1">
                                                              <tr class="gredBg">
                                                                ...
                                                                <td width="15%" align="center"><b>Loan Deduction</b></td>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td align="center"><?=$row['installments']?></td>
                                                                <td align="center"><?=getDatetime($row["installment_date"]);?></td>
                                                                <td align="center"><?=$row["installment_by"];?></td>
                                                                <td align="center"><a href="javascript:;" onClick="get_frm('edit_loan_installl.php','<?=$row["install_id"]?>','div_edit','')">
                                                                    	<img src="images/Modify.png" alt="Edit" title="Edit" border="0"></a></td>
                                                                <td align="center"><a href="javascript:;" onClick="overlay(<?=$row["install_id"]?>);">

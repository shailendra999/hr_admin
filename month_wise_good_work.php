    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/>&nbsp; Over Time Register</td>
                </tr>
                <tr>
                	<td valign="top">
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                <table align="center" width="40%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #C6B4AE;" bgcolor="#EAE3E1">
                                                   ...
                                                   <a href="javascript:;" onclick="document.location='month_wise_good_work.php';">
                                                   ...
                                                   <tr>
                                                  		 <td align="right">
                                                         	<table cellpadding="0" cellspacing="0" border="0">
                                                            	<tr>
                                                                	<td>
                                                                        <form action="print_month_wise_good_work.php" method="post" name="frm_print" id="frm_print" target="_blank">
                                                                        ...
                                                                        <td valign="top">
                                                                    <form action="print_month_wise_good_work_excel.php" method="post" name="frm_print_xls" id="frm_print_xls" target="_blank" style="display:inline;">
                                                                        <input type="hidden" name="print_month" id="print_month" value="<?=$month?>"/>
                                                                        <input type="hidden" name="print_year" id="print_year" value="<?=$year?>"/>
                                                                        <input type="hidden" name="print_employee_type" id="print_employee_type" value="<?=$employee_type?>"/>
                                                                        <input type="hidden" name="print_ticket_id" id="print_ticket_id" value="<?=$ticket_id?>"/>

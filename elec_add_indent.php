...
if(isset($_GET['mode']))
{
	...
	{
		echo "<script>alert('You Cant Edit, Purchase Order Or GRN is Made for this Indent.');location.href='elec_list_indent.php';</script>";
	}
}
	...
	{ 
		...
		{	
			...
			if(updateDataIntoTable($tableName,$tableColumns,$tableData))
			{
				...
				//echo $Message;
				redirect("elec_list_indent.php?Message=$Message");
			}
		}
	}
}

...
if (isset($_POST['department'])) {
    if ($_POST['no_refresh'] == $_SESSION['no_refresh']) {
        ...
        $sql = "SELECT * FROM " . $mysql_table_prefix . "department_employee where emp_id = '$id' and ((
            ...
            while ($row = mysql_fetch_array($result)) {
                ...
                if (strtotime($txt_from_date) >= strtotime($row['from_date']) and strtotime($txt_from_date) <= strtotime($row['to_date'])) {
                    $sql_check = "Update " . $mysql_table_prefix . "department_employee set	
																						  to_date ='$txt_from_date' reference_id='$department' where emp_id='$id'" ;
                    ...
                    $sql_check = "Update " . $mysql_table_prefix . "department_employee set	
																						   from_date ='$txt_to_date' reference_id='$department' where emp_id='$id' ";
                    ...
                    $sql = "delete from " . $mysql_table_prefix . "department_employee where emp_id='$id' and to_date!='0000-00-00'";
                    mysql_query($sql) or die("Invalid query : " . $sql . "<br>" . mysql_errno() . " : " . mysql_error());

                    if (strtotime($current_date) == strtotime($txt_to_date)) {
                        $sql = "delete from " . $mysql_table_prefix . "department_employee where emp_id='$id'";
                        mysql_query($sql) or die("Invalid query : " . $sql . "<br>" . mysql_errno() . " : " . mysql_error());
                    }
                }
            }
       ...
       echo  "!!!!".$sql_check = "Update " . $mysql_table_prefix . "department_employee set	dept_id ='$department',rec_id='$sub_department',from_date='$txt_from_date',to_date ='$txt_to_date' where emp_id='$id'";
		...
		echo $sql_check = "Update mpc_employee_master set department ='$sub_department' where 'ticket_no='$id'";

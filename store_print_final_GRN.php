...
$mac_id = $_POST['mac_id'];
$dep_id = $_POST['dep_id'];
$Header='Purchase Register As On '.date('d-m-Y');
...
if($GRNDate != '' || $GRNDateTo != ''){
	...
	$Header .= " From ".$GRNDate." To ".$GRNDateTo."<br />";
}
if($supplier_id != ''){
  ...
  <tr>
    <td>
      <table align="center" width="100%" border="1" class="tblborder">
        <tr class="note">
            <td align="center" width="6%">GRN Date</td>
         ...
         <? if(mysql_num_rows($result)>0){
            ...
            <tr class="particulars">
			  <td align="center"><?=getDateFormate($row['GRN_date'])?><? $sno++?></td>
            ...
            $sno++;
                ...
                <td colspan="7" align="right" style="padding-right:5px">Total</td>

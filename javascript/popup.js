...
Popup.show = function(divObject, referenceObject, position, options, modal,message) {
	var popup;
...
Popup.showModal = function(divObject, referenceObject, position, options,message) {
	Popup.show(divObject, referenceObject, position, options, true,message);
};

...
var ajax_list_externalFile = 'ajax_list_buyer.php';	// Path to external file
...
function ajax_option_setValue(e, inputObj)
{
    ...
    if (document.getElementById(ajax_list_activeInput.name + '_type_hidden'))
        document.getElementById(ajax_list_activeInput.name + '_type_hidden').value = inputObj.type;

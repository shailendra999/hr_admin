...
/*if(isset($_POST["employee_type"]) and isset($_POST["ticket_id"]) and isset($_POST["department"]) and isset($_POST["sub_department"]) and isset($_POST["plant_name"]))
{*/
	if(($_POST["employee_type"] != ""))
	{
		$select_string = ", mpc_designation_master.designation_name";
	...
	{	
		$select_string = ", mpc_department_master.department_name";
	...
	if($_POST["sub_department"] != "")
	{
		...
		$where_string  .= " and mpc_department_employee.emp_id = mpc_employee_master.rec_id and mpc_department_employee.dept_id = ".$sub_department."
						   and mpc_department_employee.to_date = '0000-00-00' ";
	}
	if($_POST["plant_name"] != "")
	{	
		...
		$where_string  .= "and mpc_plant_employee.emp_id = mpc_employee_master.rec_id and mpc_plant_employee.plant_id = ".$plant_name."
						   and mpc_plant_employee.to_date = '0000-00-00' ";
	}
//}
...
//   echo "hiii";
	  ...
	  $sql_prj = "
	 			select
					...
					mpc_employee_master.father_husband_name,
					mpc_official_detail.emp_id,
					mpc_account_detail.emp_id,
					mpc_account_detail.date_releaving ".$select_string."
				from
					".$mysql_table_prefix."employee_master,
					mpc_official_detail,
					mpc_account_detail ".$table_list."
				where
					mpc_employee_master.rec_id !='' and mpc_employee_master.rec_id = mpc_official_detail.emp_id and YEAR(mpc_official_detail.date_joining) <= ".$year." and
					mpc_employee_master.rec_id = mpc_account_detail.emp_id and
					mpc_account_detail.date_releaving = '0000-00-00'
					 ". $where_string."
				order by
					mpc_employee_master.ticket_no ASC
				";
...
<table width="98%" cellpadding="0" cellspacing="0" align="center" border="0">
  <tr>
    ...
    <td style="padding-left:5px; padding-top:5px;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
        <tr>
          <td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Report-> </a>form-d bonus report
          </td>
        </tr>
        <tr>
          <td valign="top"><table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td><table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                    ...
                    <tr>
                      <td align="center" valign="top"><table align="center" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:5px;" bgcolor="#f3fbd2">
                          <tr>
                            ...
                            <form name="frm_month" id="frm_month" action="" method="post">
                                <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0">
                                  ...
                                  <tr>
                                    <td class="text_1" colspan="2"> Filter By: </td>
                                    </tr>
                                    <tr>
                                  ...
                                  <tr>
                                    <td colspan="6" align="center" style="padding-top:5px;"><input name="no_refresh" type="hidden" id="no_refresh" value="<?php echo uniqid(rand()); ?>" /></td>
                                    <td>
                                    <input type="image" src="images/btn_view.jpg" name="btn_submit" id="btn_submit" value="View"/>
                                    <a href="javascript:;" onclick="document.location='formd_bonus_report.php';"> <img src="images/submit_button_Mahima.jpg" name="over" border="0"></a>
                                    </td>
                                  </tr>
                                </table>
                              </form>
                    ...
                    <tr>
                      <td align="center" valign="top" style="padding-top:5px;"><table align="center" width="100%" cellpadding="1" cellspacing="1" border="0" style="border:1px solid #E4E4E4;">
	<?  
    if(isset($_POST["btn_submit_x"]))
    { 
    ...
    <form action="print_month_wise_attendance.php" method="post" name="frm_print" id="frm_print" target="_blank">
      ...
      <tr>
        <td align="center" width="50%"><div id="div_attandance_list" style="height:500px;width:77%;float:left; overflow:scroll;">
            <table align="center" width="100%" cellpadding="0" cellspacing="0" class="table1" border="1">
              <tr class="gredBg">
                ...
                <td align="center">
                <b>Whether he has completed years of age at the
                beginning of the accounting year<br/></b>
                </td>
                <td align="center"><b>Designation</b></td>
                <td align="center"><b>No.of days worked in the year</b></td>
                <td align="center">
                <b>Total salary of wages in respect of the accounting year</b>
                </td>
                <td align="center"><b>Rate of Bonus</b></td>
                <td align="center">
                <b>Amount of Bonus payable under sec.1 C or sec 11 of the case may be</b>
                </td>
                <td align="center">
                <b>Puja Bonus or other customary Bonus paid during paid year</b>
                </td>
                <td align="center"><b>Interim bonus paid in advance</b></td>
                <td align="center">
                <b>Duduction on account of financial miscon-duct of the employee</b>
                </td>
    ...
    while($row = mysql_fetch_array($result_prj))
	{
		...
		<tr <? if ($sno % 2 == 1) { ?> bgcolor="#F8F8F8" <? } ?> class="tableTxt">
            ...
            <td width="5%" align="center"> <?=$row['department_name']?> </td>
            <td width="5%" align="left"> <?=$row['first_name']?> <?=$row['last_name']?><br/></td>
            <td width="5%" align="center"> <?=$row['father_husband_name']?> </td>
            <td>
            <?
            ...
            <td width="5%" align="center"> <?=$row['designation_name']?> </td>
            <td><?= $d ?></td>
            <td><?= round($total_salary_earing,2) ?></td>
            <td>8.33</td>

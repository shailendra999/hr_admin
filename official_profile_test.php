...
?>>
    <form name="offical_profile" id="offical_profile" action="employee_detail.php?mode=offical_profile" method="post" enctype="multipart/form-data" onSubmit="return valid_customer(this);">
        <table align="center" width="100%" cellpadding="2" cellspacing="2" class="border" border="0" style="padding-top:10px;">
            <tr style="display:none;"><td><input type="text" name="test" value="<?php echo $test = $_SESSION['emp_id']; ?>" /></td></tr>
            <tr>
                <td width="50%" valign="top"><table align="center" width="100%" cellpadding="2" cellspacing="2" class="border">
                        <tr>
                            ...
                            <td align="left"><input type="text" name="date_joining" id="date_joining" style="width:150px; height:20px;" value="<?= $date_joining ?>" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']" />
                            </td>
                        </tr>
                        <tr>
                ...
                <td width="50%" valign="top"><table align="center" width="100%" cellpadding="2" cellspacing="2" class="border" height="185px">
                        ...
                        <tr>
                            ...
                            <td align="left"><select name="emp_type" id="emp_type">
                                    <option value="fix_salary" <?
                                    if ($employee_typ == 'fix_salary') {
                                        echo 'selected="selected"';
                                    }
                                    ?> >Fix Salary</option>
                                    <option value="daily_wages" <?
                        ...
                        <tr>
                            <td class="text_1">Employee Category</td>
                            <td align="left"><select  name="emp_category" id="emp_category" onChange="get_frm('get_designation.php', this.value, 'designation_div', 'designation');">
                                    <option value="staff" <?
                                    if ($emp_category == 'staff') {
                                        echo 'selected="selected"';
                                    }
                                    ?>>Staff</option>
                                    <option value="worker" <?
                                    if ($emp_category == 'Worker') {
                                        echo 'selected="selected"';
                                    }
                                    ?>>Worker</option>
                                </select></td>
                        ...
                        <tr>
                            ...
                            <td align="left"><div id="designation_div">
                                    <?
                                    $sql = "SELECT * FROM  mpc_designation_master order by designation_name";
                                    ...
                                    <select name="designation" id="designation" style="width:150px; height:25px;">
                                        ...
                                        if (mysql_num_rows($result_city) > 0) {
                                            while ($row_city = mysql_fetch_array($result_city)) {
                                                ?>
                                                <option value="<?= $row_city['rec_id'] ?>" <?
                                                if ($row_city['rec_id'] == $designation_id) {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>
            ...
            <tr>
                <td colspan="2" style="text-align:center;"><!-- ************************************Added pf details************************************************  *** -->
                        ...
                        <table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                            ...
                            <tr>
                                <td align="left" width="50%"><table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left"><input type="text" name="date_pf" id="date_pf" style="width:150px; height:20px;" value="<?= $date_pf ?>" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']"  />
                                            </td>
                                        </tr>
                                    </table></td>
                                <td width="50%"><table width="100%" height="179px" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                        <tr>
                                ...
                                <td><table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" width="50%"><table width="100%" height="67px" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                                    <tr>
                                                        <td class="text_1" width="100%">Bonus Rate&nbsp;&nbsp;Bonus
                                                            <input type="text" name="bonus_rate" id="bonus_rate" value="<?= $bonus_rate ?>" /></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        <tr>
                            ...
                            <tr class="test">
                                <td><table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                        ...
                                        <tr>
                                            <td class="text_1">ESIC RATE(EMPLOYEE)</td>
                                            <td><input type="text" name="esic_rate" id="esic_rate" style="width:180px; height:20px;" value="<?= $esic_rate ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td class="text_1">ESIC RATE(EMPLOYER)</td>

                                            <td><input type="text" name="esic_rate_employer" id="esic_rate_employer" style="width:180px; height:20px;" value="<?= $esic_rate_employer ?>"/></td>
                                        </tr>

                                    </table></td>
                                <td><table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border" height="174px">
                                        <tr>
                    ...
                    <table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                        ...
                        <tr>
                            <td align="left" width="50%"><table border="0" align="center" width="100%" cellspacing="2" cellpadding="2" class="border" style="margin-left:0px">
                                    <tr>
                                        ...
                                        <td align="center" valign="middle"><select name="rotation_type" id="rotation_type" style="width:150px; height:25px;">
                                                ...
                                                <option <?php
                                                if ($rotation_type == '2 Week') {
                                                    echo 'selected';
                                                }
                                                ?> value="2 Week">2 Week</option>
                                                <option <?php
                            ...
                            <td><table style="width:526px;margin-right:0px;" height="120px" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                    <tr>
                    ...
                    <div id="div_insert_bank">
                        <table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                            ...
                            <tr>
                                <td align="left" valign="top" width="50%"><table width="100%" height="118px" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
                                        <tr>
                                            ...
                                            <td align="left" width="40%"><select id="payment_mode" name="payment_mode">
                                                    ...
                                                    ?> selected value="Cash">Cash</option>
                                                    <option <?php
                    ...
                    <div align="center">
                        <input type="submit"  value="Next" name="emp_offical" id="#emp_offical"/>

...
function getDataInDiv(value,divId,page,byControl){
	//alert(value+' '+divId+' '+page+' '+byControl);
      		...
      		<table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
        		<tr>
          			<td align="center" class="gray_bg">
			            <img src="images/bullet.gif" width="15" height="22"/> &nbsp; Stock Quantity Report
          			</td>
		        </tr>
        		<tr>
                                        ...
                                        <table align="center" width="100%" border="1" class="table1 text_1">
                                          	<tr>
                                           	...
                                           	<tr>
                                                ...
                                                <td align="left">
                                                    <select name="item_id" id="item_id" style="width:50px; font-size:10px;" onChange="getDataInDiv(this.value,'getItemsInDiv','store_get_report_stock.php','ItemId')" >
                                                        <option value="">-Select-</option>
...
<div class="AddMore" style="padding-bottom:10px;" id="divPrint">
	<form action="xls/store_report_stock_ledger_qty.php" name="excel" id="excel" method="post" target="_blank">

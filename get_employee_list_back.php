...
$holiday=getHoliday('holiday_name',$date);
 ...
 echo $sql="SELECT  mpc_employee_master.emp_id,mpc_attendence_master.emp_id, mpc_attendence_master.shift,mpc_employee_master.first_name,mpc_employee_master.last_name,mpc_attendence_master.attendance_status,mpc_attendence_master.badli_as,mpc_designation_master.rec_id,mpc_designation_master.emp_category ,mpc_designation_employee.designation_id,mpc_designation_employee.to_date,mpc_designation_employee.emp_id FROM mpc_attendence_master,mpc_employee_master,mpc_designation_employee,mpc_designation_master where date='$date' and mpc_employee_master.rec_id =mpc_attendence_master.emp_id and mpc_attendence_master.emp_id='$id' and mpc_designation_employee.emp_id =mpc_employee_master.rec_id and mpc_designation_employee.designation_id=mpc_designation_master.rec_id and mpc_designation_master.emp_category='$type' and mpc_designation_employee.to_date='0000-00-00'";
	...
	else
	{
		...
		$sql="SELECT mpc_employee_master.emp_id,mpc_employee_master.first_name,mpc_employee_master.last_name,mpc_designation_master.rec_id,mpc_designation_master.emp_category ,mpc_designation_employee.designation_id , mpc_designation_employee.to_date,mpc_designation_employee.emp_id FROM mpc_employee_master,mpc_designation_employee,mpc_designation_master where mpc_employee_master.rec_id='$id' and mpc_designation_employee.emp_id =mpc_employee_master.rec_id and mpc_designation_employee.designation_id=mpc_designation_master.rec_id and mpc_designation_master.emp_category='$type' and mpc_designation_employee.to_date='0000-00-00'";

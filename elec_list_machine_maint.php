...
<?
$Page = "elec_list_machine_maint.php";
$PageTitle = "List Machine Maintenance";
...
if(isset($_POST["btn_del"]))
{
	...
	$sql = "delete from elec_machine_maint where $PageKey = '".$PageKeyValue."'";
	if(mysql_query ($sql))
	{
...
?>
<?
$sql="select * from elec_machine_maint order by machine_maint_date asc";
      ...
      <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td align="center" class="gray_bg">
          	<img src="images/bullet.gif" width="15" height="22"/> &nbsp; List Machine Maintenance
          </td>
        </tr>
        <tr>
          <td valign="top">
                  ...
                  <table align="center" width="100%" border="1" class="table1 text_1">
                    ...
                    <tr>
                      ...
                      <input type="text" name="DTo" id="DTo" />
                        ...
                        <input type="button" id="btnOk" name="btnOk" value="Ok" onclick="getDataInDiv('getDataInDiv','elec_get_list_machine_maint.php')"/>
                       </td>
                    </tr>
                  </table>
                   <div id="getDataInDiv" style="margin:0 auto;width:100%;overflow:auto;height:850px;">
                  	<table align="center" width="100%" border="1" class="table1 text_1">
                      <tr>
                        <td class="gredBg"><b>SNo.</b></td>
                        <td class="gredBg"><b>Date</b></td>
                        <td class="gredBg"><b>Department</b></td>
                        <td class="gredBg"><b>Machine</b></td>
                        <td class="gredBg"><b>Details</b></td>

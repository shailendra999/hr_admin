...
<title>Print All RETURNABLE/REPAIRABLE GATE PASS</title>
<style>
.note
{
padding-left:35px;
...
<tr>
  ...
  <tr>
    <td>
        ...
        <?
        $sql_order_trans="SELECT * FROM ms_RGP_master mom, ms_RGP_transaction mot WHERE mom.RGP_id = mot.RGP_id AND mom.RGP_id ='".$row['RGP_id']."'";
    ...
    <tr>
  	<td>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
           	 <tr valign="top" height="80px"><td align="center" colspan="3"><span style="font-size:14px;">(NOTE:- GATE PASS WITH ORIGINAL INVOICE COPY)</span></td></tr>
             <tr height="40px">

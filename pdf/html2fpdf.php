...
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH','pdf/font/');
  ...
  if($tag=='OUTLINE')
  {
   ...
   //Reset values
    ...
    $this->blockjustfinished = true; //Eliminate exceeding left-side spaces
		...
		$this->table['wc'] = array_pad(array(),$this->table['td'],array('miw'=>0,'maw'=>0));
		$this->table['hr'] = array_pad(array(),$this->table['tr'],0);

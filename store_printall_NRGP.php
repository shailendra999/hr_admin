...
<title>Print All NON RETURNABLE GATE PASS</title>
<style>
.note
{
padding-left:35px;
...
<body onload="print();">
<?
	$sql = "select * from ms_NRGP_master ";
...
<tr>
  ...
  <tr>
    <td>
        ...
        <?
        $sql_order_trans="SELECT * FROM ms_NRGP_master mom, ms_NRGP_transaction mot WHERE mom.NRGP_id = mot.NRGP_id AND mom.NRGP_id ='".$row['NRGP_id']."'";

    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;vertical-align:top;" >
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/> &nbsp;Deptt/Shift Wise Absentee Report</td>
                </tr>
                <tr>
                	<td class="heading" valign="top" style="padding-top:5px;">
                    <form id="frm_absent_list" name="frm_absent_list" method="post" action="shift_wise_absent_report_excel.php" target="_blank">
                    	<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                            <tr>
                                <td width="100%" colspan="2" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" align="center" class="loginbg">
                                        <tr>
                                            <td class="text_1" style="padding-left:15px;" width="6%">Date<span class="red">*</span></td>
                                            <td width="20%"><input type="text" name="txt_date" id="txt_date" value="<?=$date?>" style="width:150px; height:20px;" data-beatpicker="true"/>

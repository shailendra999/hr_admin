                 ...
                 <table id="" align="center" width="100%" border="1" class="table1 text_1">
                    ...
                    <tr>
                      ...
                      <td colspan="3" align="left">
                      	<select id="item_name" name="item_name" style="width:200px" onchange="getItemsByName(this.value,'getItemsInDiv','elec_get_list_item.php','ItemId')">
                     ...
                     <tr>
                      ...
                      <td>
                      	<select id="department_id" name="department_id" style="width:150px" onchange="getItemsByName(this.value,'getItemsInDiv','elec_get_list_item.php','Department')">
                        	<option value="0"></option>
													<?
                      ...
                      <td><b>Machinary</b></td>
                      <td>
                      	<select id="machinary_id" name="machinary_id" style="width:150px" onchange="getItemsByName(this.value,'getItemsInDiv','elec_get_list_item.php','Machinary')">
                          <option value="0"></option>
                          <?
                    ...
                    <tr>
                      ...
                      <td>
                    		<input type="text" id="drawingNo" name="drawingNo" style="width:150px" onkeyup="getItemsByName(this.value,'getItemsInDiv','elec_get_list_item.php','DrawingNumber')"/>
                      </td>
                      <td><b>Catelog Number</b></td>
                      <td>
                    		<input type="text" id="catelogNo" name="catelogNo" style="width:150px" onkeyup="getItemsByName(this.value,'getItemsInDiv','elec_get_list_item.php','CatelogNumber')"/>
                      </td>
                    </tr>
                  </table>

...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td width="13%">
                        <input type="text" id="emp_search" name="emp_search" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                    get_frm_menu('employee_listloan.php', this.value, 'emp_list', '');
                                }" value="<?= $ticket_no ?>"/>
                    </td>
                    <td width="72%" class="text_1" style="padding-top:5px;">
                        <form name="frm_check" id="frm_check">
                            <input type="radio" id="search_by" name="search_by" value="ID" checked="checked" onclick="get_frm_menu('employee_listloan.php', document.getElementById('emp_search').value, 'emp_list', '')" />ID
                            <input type="radio" id="search_by" name="search_by"  value="Name" onclick="get_frm_menu('employee_listloan.php', document.getElementById('emp_search').value, 'emp_list', '')"/>Name
                            <input type="radio" id="search_by" name="search_by"  value="Employee" onclick="get_frm_menu('employee_listloan.php', document.getElementById('emp_search').value, 'emp_list', '')"/>Department Name
                        </form>
    ...
    <tr>
        <td id="td_data" align="left" class="menuLink" style="border-right:1px solid #CCCCCC; border-left:1px solid #CCCCCC; padding-top:1px;" width="200px" valign="top">
            ...
            <? $action = ""; ?>
            <div id="emp_list" style="overflow:scroll;height:350px;width:300px;">
                <?php //include('list_loan.php'); ?>

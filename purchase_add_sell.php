                                    ...
                                    <div align="center" style="min-height:470px; padding-top:15px;">
                                        ...
                                        <form id="purchase_frm_sell" name="purchase_frm_sell" action="" method="post">
                                            <table align="center" cellpadding="1" cellspacing="1" border="0" width="100%" style="border:#CCCCCC solid 1px;">
                                                <tr>
                                                	<td>Company Name</td><td>Product</td><td>Quantity</td><td>Date</td>
                                                </tr>
                                                <tr>
                                                	<td>
                                                  		<?
                                            ...
                                            <td width="50%" colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <?
																											...
																											$sql_res = mysql_query($sql_company) or die(mysql_error());
																										?>
                                                    <select name="company_id" id="company_id" style="width:145px;">
                                                    <option value="0"></option>
                                                    <?
																											if(mysql_num_rows($sql_res)>0)
																											{
                                                ...
                                                <tr>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <?
																											...
																											$sql_res = mysql_query($sql_prod) or die(mysql_error());
																										?>
                                                    <select name="product_id" id="product_id" style="width:145px;">
                                                    <?
																											if(mysql_num_rows($sql_res)>0)
																											{
																													while($row_prod = mysql_fetch_array($sql_res))

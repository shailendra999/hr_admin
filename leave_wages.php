...
else
{
	...
	$sql_prj = "select * from ".$mysql_table_prefix."employee_master order by first_name";
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                <tr>
                    <td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/> &nbsp;Leave Wages(Form-18)</td>
                </tr>
				<tr>
                	<td valign="top">
                    	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                        	<tr>
                            	<td valign="top">
                            		<? include("list_employee_leave_wages.php"); ?>
                                </td>
                          </tr>
                        </table>
                    </td>

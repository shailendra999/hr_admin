...
header("Content-Disposition: attachment; filename=attandance_register-" . $month . "-" . $year . ".xls");
$employee_type = "";
$department = "";
$sub_department = "";
$plant_name = "";
    ...
    <tr>      
        <td style="padding-left:5px; padding-top:5px;" valign="top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                ...
                <tr>
                    <td align="left">Attendance Register MONTH -<?= date("F", mktime(0, 0, 0, $month, 1, 0)) ?>,<?= $year ?></td>
                </tr>
                <tr>

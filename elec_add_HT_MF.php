...
{
	$mode = $_GET["mode"];
	$sql_idate="select * from elec_HT_MF where insert_date='".date('Y-m-d')."' and $PageKey='".$_GET[$PageKey]."'";
...
if(isset($_POST["btn_submit"]))
{
	...
	if($mode == "edit")
	{					
		$tableName="elec_HT_MF";
		$tableColumns=array("HT_mf_id","factor");
...
{
	$sql = "select * from elec_HT_MF where $PageKey = '".$_GET[$PageKey]."'";
                  ...
                  <div align="center" style="min-height:470px;padding-bottom:15px; padding-top:15px;">
                      ...
                      <form id="frm_add" name="frm_add" method="post">
                        <table align="center" cellpadding="1" cellspacing="1" bgcolor="#EAE3E1" border="0" width="60%" class="text_1">
                          <tr>
                            <td align="left"><b>HT Multiflying Factor Id</b></td>
                            <td align="left">
                            	<input type="text" id="HT_mf_code" name="HT_mf_code" value="<?= $HT_mf_id ?>" />
                            </td>
                          </tr>
                          <tr>
                    ...
                    <?
                    $sql = "select * from elec_HT_MF order by HT_mf_id";
                    $result = mysql_query ($sql) or die ("Invalid query : ".$sql."<br>".mysql_errno()." : ".mysql_error());
                    if(mysql_num_rows($result)>0)
                    {
											$sno=1;
											...
											{ 
											$sql_idate="select * from elec_HT_MF where insert_date='".date('Y-m-d')."' and HT_mf_id='".$row['HT_mf_id']."'";
											$res_idate=mysql_query($sql_idate);
											...
											$insert_date=$row_idate['insert_date'];
												...
												<tr>
													...
													<?
														...
														?>
															<td align="center">
																<a href="elec_add_HT_MF.php?HT_mf_id=<?=$row['HT_mf_id']?>&mode=edit"title="Edit" >

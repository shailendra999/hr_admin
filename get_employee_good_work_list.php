...
////////////////////// Markin attendence //////////////
	...
	$sql = "delete from ".$mysql_table_prefix."good_work_master where emp_id = '".$id."' and date ='$txt_date' ";
	mysql_query ($sql) or die ("Invalid query : ".$sql."<br>".mysql_errno()." : ".mysql_error());
	 
	 $sql_check = "insert into ".$mysql_table_prefix."good_work_master set	
																		emp_id ='$id',
																		date ='$txt_date',
																		good_work ='$good_work',
																		shift ='$shift',
	...
	{
	$sql = "delete from ".$mysql_table_prefix."good_work_master where emp_id = '".$id."' and date ='$txt_date' and shift='G'";
	mysql_query ($sql) or die ("Invalid query : ".$sql."<br>".mysql_errno()." : ".mysql_error());

...
?>
		<table align="center" width="100%" border="0" class="border">
			<tr bgcolor="#FFFFFF">
				<td width="6%" class="headingSmallPrint" align="center"><b>Invoice No</b></td>
				<td width="27%" class="headingSmallPrint" align="center"><b>Invoice Dt.</b></td>
				<td width="27%" class="headingSmallPrint" align="center"><b>Buyer</b></td>
				<td width="20%" class="headingSmallPrint" align="center"><b>port</b></td>
				<td width="8%" class="headingSmallPrint" align="center"><b>Country</b></td>
				<td width="6%" class="headingSmallPrint" align="center"><b>Item</b></td>
				<td width="6%" class="headingSmallPrint" align="center"><b>Quantity Net in kg</b></td>
				<td width="6%" class="headingSmallPrint" align="center"><b>Invoice Amt. in USD</b></td>
				<?

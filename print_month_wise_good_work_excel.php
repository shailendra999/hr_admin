...
and isset($_POST["print_plant_name"]))
	...
	if($_POST["print_department"]!="" and $_POST["print_sub_department"]=="")
     ...
     @header("Location:Content-type: application/vnd.ms-excel");
     @header("Location:Content-Disposition: attachment; filename=good_work_register-".$month."-".$year.".xls")
?>
    ...
    <tr>      
        <td style="padding-left:5px; padding-top:5px;" valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                ...
                <tr>
                	<td align="left">Good Work Sheet for <?php if($_POST["print_plant_name"]!=""){echo '-Plant :'.$_POST["print_plant_name"]; } ?><?php if($_POST["print_employee_type"]!=""){echo '-Employee Type :'.$_POST["print_employee_type"]; } ?> <? if($_POST["print_department"]!=""){echo '-Department :'.$_POST["print_department"];}?><? if($_POST["print_sub_department"]!="")
		{echo '-Sub Department :'.$_POST["print_sub_department"];}?><?php if($_POST["print_ticket_id"]!="")

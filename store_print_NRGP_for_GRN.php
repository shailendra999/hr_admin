...
<table width="100%" class="tblborder" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
        ...
        <?
        $sql_order_trans="SELECT * FROM ms_NRGP_master mom, ms_NRGP_GRN_transaction mot WHERE mom.NRGP_id = mot.NRGP_id AND mom.NRGP_id ='".$PageKeyValue."'";
          ...
          <tr class="particulars">
            ...
            <td align="left" style="padding-left:10px">
              ...
              echo $row_item['name']."<br>";
							echo "<b>Draw. No. :</b> " .$row_item['drawing_number']."<br>";
							echo "<b>Cat. No. :</b> " .$row_item['catelog_number'];
              ?>
            </td>
            <td align="center">
            <? 

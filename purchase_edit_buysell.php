                                      	...
                                      	Is Entry Confirmed <input type="checkbox" id="IsEntryChecked" name="IsEntryChecked" value="1" />
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="6" align="center" style="padding-top:5px;">
                                                                            ...
                                                                            <a href="javascript:;" onClick="document.location='purchase_edit_buysell.php';">
                                                                	...
                                                                	<td valign="top">
                                                                    	<table width="100%" border="0" class="table1">
                                                                            ...
                                                                            <tr valign="top" class="tableTxt">
                                                                            	<td align="center" >
                                                                                	<?=getDateFormate($row_sell["sell_date"])?>                                                                                </td>
                                                                                <td align="center">
                                                                                	<?=$row_sell["name"]?>                                                                                </td>
                                                                                <td align="center"><?=$row_sell["form_name"]?></td>
                                                                  <td align="center">
                                                                                	<?=$row_sell["product_name"]?>                                                                                </td>
                                                                                <td align="center">
                                                                                	<?=$row_sell["quantity"]?>                                                                                </td>
                                                                                <td align="center">
																					<?=$IsEntryChecked = ($row_sell["IsEntryChecked"]) ? "Yes" : "No";?>                                                                                </td>
                                                                                <td align="center">

                                                                                    <a href="purchase_add_buysell.php?sell_id=<?=$row_sell["sell_id"]?>">Edit</a>                                                                                	
                                                                               	</td>

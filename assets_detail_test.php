<?php
if (isset($_POST['emp_assest']) || isset($_POST['Submit_emp2'])) {
    $id = $_SESSION['emp_id'];
    ...
    if ($emp_assest_edit == "") {
        echo $que = mysql_query("INSERT INTO `ssofts_lss`.`assets_detail` (`rec_id`, `emp_id`, `Vehicle`, `Registration`, `Model`, `Vehicle_no`, `laptop`, `tv`, `assist_all`, `other`) VALUES ('', '$id', '$vehicle', '$registration_no', '$model_no', '$no_vehicle', '$laptop_detail', '$all_details', '$assists_all', '$other');");
    } else {
...
?>>
    <form name="assets_details_test.php" id="empolyee_family" action="<?php
    ...
    ?>" method="post" enctype="multipart/form-data" ><!--onSubmit="return valid_customer(this);"-->
        <table align="center" width="63%" cellpadding="2" cellspacing="2" class="border" border="0" style="padding-top:10px;">   
            <tr>
                <td width="50%" valign="top"><table align="center" width="100%" height="344px;" cellpadding="2" cellspacing="2" class="table">   
                        <tr>
                ...
                <td width="50%" valign="top"><table align="center" width="100%" cellpadding="2" cellspacing="2" class="border">
                        <tr>
                            <td class="text_1">Laptop(Mode and company all Data in brief)</td>
                        ...
                        <tr>
                            <td class="text_1">Assets All(what ever is issued by the company)</td>
            ...
            <tr>
                <td style="text-align:center;" colspan="4">
                    <input type="submit"  value="Next" name="emp_assest" id="emp_assest"/>
                    <? if (isset($_SESSION['emp_id'])) {
                        ?>
                                           <!--   <input type="submit"  value="Done" name="Submit_emp2" id="Submit_emp2" onClick="document.location='list_employee.php?ticket_no=<?= $ticket_no ?>';"/></td></tr>-->
            </table>
    </div>

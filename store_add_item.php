...
function validateItem(value,url,divID,byControl) {
	
	
	if(byControl=='Name')
		url+="?byControl="+byControl+"&value="+value+"&sid="+Math.random();
			...
			reg.onreadystatechange = function() {
					if (reg.readyState == 4) {
							...
							{                        
								if(reg.responseText!='')
								{
									alert("Value Already Exists.Change This Value.");
...
{
	var status=true;
	if(document.getElementById("name").value=="" || document.getElementById("department_id").value=='0')
	{
                      ...
                      <td align="center" valign="top" class="border" width="100%" bgcolor="#EAE3E1">
                        <table align="center" width="100%" cellpadding="2" cellspacing="2" border="0" class="text_1">
                          ...
                          <tr>
                            ...
                            <td align="left">
                              <input type="text" id="name" name="name" value="<?= $name ?>" onkeyup="validateItem(this.value,'store_validate_item_name.php','divItemValidate','Name')" />
                            </td>
                          ...
                          <tr>
                            ...
                            <td align="left">
                              <input type="text" id="drawing_number" name="drawing_number" value="<?= $drawing_number ?>" onkeyup="validateItem(this.value,'store_validate_item_name.php','divItemValidate','DrawingNumber')"/>
                            </td>
                            <td align="left"><b>Catelog Number</b></td>
                            <td align="left">
                              <input type="text" id="catelog_number" name="catelog_number" value="<?= $catelog_number ?>" onkeyup="validateItem(this.value,'store_validate_item_name.php','divItemValidate','CatelogNumber')" />
                            </td>
                          </tr>
                          <tr>

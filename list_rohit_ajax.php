    	...
    	<td align="left" style="padding-top:5px;" colspan="2">
        	<table cellpadding="0" cellspacing="0" border="0" align="left" class="loginbg" width="98%">
                <tr>
                    ...
                    <td width="13%">
                    	<input type="text" id="emp_search" name="emp_search" onkeydown="if(event.keyCode && event.keyCode == 13){get_frm_menu('rohit.php',this.value,'emp_list','');}" value="<?=$ticket_no ?>"/>
                    </td>
                    <td width="72%" class="text_1" style="padding-top:5px;">
						<form name="frm_check" id="frm_check">
                        <input type="radio" id="search_by" name="search_by" value="ID" checked="checked" onclick="get_frm_menu('rohit.php',document.getElementById('emp_search').value,'emp_list','')" />ID
                       		 <input type="radio" id="search_by" name="search_by"  value="Name" onclick="get_frm_menu('rohit.php',document.getElementById('emp_search').value,'emp_list','')"/>Name
...
$(document).ready(function(){
	...
	<? $action="";?>
            ...
            <?php include('load/load_rohit.php');?>

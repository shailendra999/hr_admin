    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/> &nbsp; Export Doc Report</td>
                </tr>
                <tr>
                	<td valign="top">
                        <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                <td valign="top" align="center" style="padding-top:5px;">
                                	<form id="frm_pi_search" name="" method="post" action="export_doc_report.php">
                                            ...
                                            <td align="center" valign="top">
                                                <table align="center" width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    ?>
                                                            <table align="center" width="100%" border="0" class="border">
                                                                <tr>
                                                                    ...
                                                                    <td width="8%" class="gredBg">I. Dt.</td>
                                                                    <td width="12%" class="gredBg">Buyer</td>
                                                                    <td width="8%" class="gredBg">port</td>
                                                                    <td width="8%" class="gredBg">Country</td>
                                                                    <td width="8%" class="gredBg">Item</td>
                                                                    <td width="14%" class="gredBg">Quantity Net in kg</td>
                                                                    <td width="15%" class="gredBg">Invoice Amt. in USD</td>
                                                                  	<?
																	...
																	if(mysql_num_rows($result_doc)>0)
                                                    				{
                                                        				...
                                                        				{
																		?>
                                                                       	<td width="5%" class="gredBg">
                                                                        	<?=$row_doc["DocumentName"]?>
                                                                        </td>
                                                                        <?
																		}
																	}
                                                    ...
                                                    ?>         
                                                        ...
                                                        ?>  
                                                            <div class="AddMore">
    	                                                        <a href="export_doc_report_xls.php">Export To XLS</a>  
                                                            </div>
                                                        </td>
                                                    </tr>
                                               </table>

...
if (isset($_POST['btn_attend'])) {
    ...
    foreach ($emp_id as $id) {
        ...
        $sql_check = "insert into " . $mysql_table_prefix . "attendence_master set	
			...
			date ='$txt_date',todate ='$txt_todate',time ='$time',
			time_out ='$time_out',good_work ='$good_work',InsertBy ='$id',
                                    ...
                                    <td width="100%" colspan="2" align="center">
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" class="loginbg">
                                            <tr>
                                                ...
                                                <td width="15%">
                                                    <input type="text"name="txt_date" id="txt_date" value="<?= $date ?>" style="width:100px; height:20px;" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                                                document.getElementById('employee_type').focus();
                                                            }" readonly="readonly"/>
                                                ...
                                                <td width="15%"><input type="text"
                                                                       name="txt_todate" id="txt_date1" value="<?= $date ?>" style="width:100px; height:20px;" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                                                                   document.getElementById('employee_type').focus();
                                                                               }" readonly="readonly"/>
                                                ...
                                                <td width="13%">
                                                    <select name="employee_type" id="employee_type" onChange="shift_check(this)" style="width:100px; height:20px;" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                                            document.getElementById('shift_detail').focus();
                                                        }">
                                                ...
                                                <td width="16%" align="left" style="padding-left:20px;">
                                                    <div id="div_shift">
                                                        <select name="shift_detail" id="shift_detail" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                                                ...
                                                                }"><option value="">---Select---</option><option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="G">G</option></select>
                                                    </div>                                          </td>
                                                ...
                                                <td width="24%" align="left" style="padding-left:20px;">
                                                    ...
                                                    <a href="#test" data-rel="popup" class="ui-btn ui-btn-inline ui-corner-all">Show Popup</a>                                      
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
//Upload File
                                if (isset($_POST['submit'])) {
                                    ...
                                    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                                        print_r($data);
                                        $import = "INSERT into table_name(item1,item2,item3,item4,item5) values('$data[0]','$data[1]','$data[2]','$data[3]','$data[4]')";

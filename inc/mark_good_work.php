    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/> &nbsp; Mark Good Work</td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td width="100%" colspan="2" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" align="center" class="loginbg">
                                        <tr>
                                            <td class="text_1" style="padding-left:15px;" width="12%">Good WorkDate<span class="red">*</span></td>
         ...
         name="txt_date" id="txt_date" value="<?=$date?>" style="width:100px; height:20px;" onkeydown="if(event.keyCode && event.keyCode == 13){document.getElementById('employee_type').focus();}" readonly="readonly"/>
                                            <a href="javascript:void(0)" onClick="gfPop.fPopCalendar(document.frm_emp_list.txt_date,[[1980,1,1],[<?=$current_year?>,<?=$current_month?>,<?=$current_date?>],[2010,08]]);"><img name="popcal" align="absbottom" src="./calendar/calbtn.gif" width="34" height="22" border="0" alt=""  onkeydown="if(event.keyCode && event.keyCode == 13){document.getElementById('employee_type').focus();}"></a>                                            
                                            </td>

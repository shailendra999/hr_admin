...
function mmLoadMenus() {
   ...
   mm_Company.addMenuItem("Add Company","window.open('purchase_add_company_master.php', '_parent');");
   ...
   mm_Purchaser.addMenuItem("Add Purchase","window.open('purchase_add_purchaser_master.php', '_parent');");
   ...
   window.mm_Seller = new Menu("root",150,25,"Verdana,Arial,Helvetica,sans-serif",11,"#cccccc","#ffffff","#535353","#535353","left","middle",6,0,1000,-5,7,true,true,true,0,true,true);
	 ...
	 mm_Seller.addMenuItem("Add Seller","window.open('purchase_add_seller_master.php', '_parent');");
   ...
   window.mm_Form = new Menu("root",150,25,"Verdana, Arial, Helvetica, sans-serif",11,"#cccccc","#ffffff","#535353","#535353","left","middle",6,0,1000,-5,7,true,true,true,0,false,true);
	 ...
	 mm_Form.addMenuItem("Add Form","window.open('purchase_add_form_master.php', '_parent');");
   ...
   mm_Form.bgColor='#cccccc';
	 ...
	 mm_Product.addMenuItem("Add Product","window.open('purchase_add_product_master.php', '_parent');");
   ...
   mm_Product.bgColor='#cccccc';
	 ...
	 mm_Buy_Sell.addMenuItem("Add Buyer/Seller","window.open('purchase_add_buysell_master.php', '_parent');");
	 mm_Buy_Sell.addMenuItem("Edit Buyer/Seller","window.open('purchase_edit_buysell_master.php', '_parent');");
   ...
   mm_Buy_Sell.bgColor='#cccccc'; 
	 ...
	 mm_Reports.addMenuItem("Reports ","window.open('purchase_reports_master.php', '_parent');");

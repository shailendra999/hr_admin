    ...
    <tr>
        <td width="66%" align="right">
            ...
            if ($SessionUserType == 'Administrator') {
                ...
                <a href="http://solutionsofts.com/lssadmin/administrator_homepage.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <td width="1%"><img src="images/tnb_div.jpg" width="2" height="25"/></td>
        <td width="10%"><a href="hr_setting.php">Settings</a></td>   
        <td width="1%"><img src="images/tnb_div.jpg" width="2" height="25"/></td>  
        <td width="6%"><a href="logoff.php">LogOff</a></td>
        <!--td width="6%"><a href="logoff.php"><img src="images/logoff.jpg" width="25" height="25"/></a></td-->
    </tr>
</table>
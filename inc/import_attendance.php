		                    ...
		                    <table width="100%" cellpadding="2" cellspacing="2" border="0" align="center" class="border" style="padding-top:10px;">
	                            <tr>
    		                        <td class="text_1">From Date</td>
                                        <td align="left"><input type="text" name="FromDate" id="FromDate" style="width:150px; height:20px;" value="" data-beatpicker="true"/></td>
                                </tr>
                                <tr>
    		                        <td class="text_1">To Date</td>
                                        <td align="left"><input type="text" name="ToDate" id="ToDate" style="width:150px; height:20px;" value="" data-beatpicker="true" /></td>
                                </tr>
                                <tr>
                                	<td>

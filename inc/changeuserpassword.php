...
$txtLogin= $SessionUserName;
 if(isset($_POST["Submit"]))
 {
	...
	{	
		$sql="update ".$mysql_table_prefix."employee_master set Password ='$new_pass' and 	username=$user_name where UserName ='$txtLogin'";
...
?>
<?php $sql = "SELECT * FROM ".$mysql_table_prefix."employee_master where username = '$txtLogin'";
                            ...
                            <tr>
                            	<td align="center" style="padding-top:10px;">
                                    ...
                                    <tr> 
                                      ...
                                      <tr> 
                                          <td width="40%" align="left" class="loginTxt" style="padding-left:15px;">Password</td>
                                        <td width="60%"><input type="text" name="password" id="password" value="<?php echo $row['password'];?>" style="width:180px; height:20px;"></td>
                                        </tr>
                                      <tr> 

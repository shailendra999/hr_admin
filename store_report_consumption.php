...
<div class="AddMore" style="padding-bottom:10px;" id="divPrint">
	<form action="xls/store_report_consumption.php" name="excel" id="excel" method="post" target="_blank">
    <input type="hidden" name="department_name" id="department_name" value="<?=$department_id?>" />
    <input type="hidden" name="FromDate" id="FromDate" value="<?=$FromDate?>"/>
    <input type="hidden" name="ToDate" id="ToDate" value="<?=$ToDate?>"/>
    <input type="hidden" name="Machine_name" id="Machine_name" value="<?=$machinary_id?>"/>

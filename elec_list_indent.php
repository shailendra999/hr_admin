...
if(isset($_POST["btn_del"]))
{
	...
	$sql="select * from ms_order_master where indent_id='".$PageKeyValue."'";
	$res=mysql_query($sql);
	if(mysql_num_rows($res)>0)
	{
		$Message="Not Deleted";
		echo "<script>alert('Sorry!PO is made for this Indent.You cantDelete this Record');location.href='$Page?Message=$Message';</script>";
	}
	else
	{
                ...
                <td align="center" class="border">
                  ...
                  <table align="center" width="100%" border="1" class="table1 text_1">
                    ...
                    <tr>
                      ...
                      <td align="left">
                        <input type="text" name="itemIndentSearch" id="itemIndentSearch" onKeyUp="getDataInDiv(this.value,'getItemsInDiv','elec_get_list_indent.php','IndentNo')" />
                      </td>
                      ...
                      <td align="left">
                        ...
                        <input type="button" id="btnOk" name="btnOk" value="Ok" onClick="getDataInDiv('','getItemsInDiv','elec_get_list_indent.php','IndentDate')"/>
                      </td>
                     </tr>
                      <td align="left"><b>Department</b></td>
                      <td align="left">
                      	<select name="department_id" id="department_id" style="width:150px;height:20px" onChange="getDataInDiv(this.value,'getItemsInDiv','elec_get_list_indent.php','Department')" >
                      ...
                      <td align="left">
                      	<select name="item_id" id="item_id" style="width:150px;height:20px" onChange="getDataInDiv(this.value,'getItemsInDiv','elec_get_list_indent.php','Item')" >
                          <option value="0"></option>
                          <? 
                              ...
                              <tr <? if ($sno%2==1) { ?> bgcolor="#F5F2F1" <? } ?>>
                               ...
                               <?
                                ...
                                //if($count==1)
                                {
                                  ?>
                                  <td align="center">
                                    <a href="elec_view_indent.php?indent_id=<?=$row["indent_id"]?>">
                                  ...
                                  ?>
                                  <td align="center">
                                    <a href="elec_add_indent.php?indent_id=<?=$row["indent_id"]?>&mode=edit">

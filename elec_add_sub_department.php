...
<?
$Page = "elec_add_sub_department.php";
$PageTitle = "Add Sub Department";
$PageFor = "Sub Department";
$PageKey = "sub_department_id";
$PageKeyValue = "";
$Message = "";
$mode = "";
$PageKeyValue = "";
...
{
	$mode = $_GET["mode"];
	$sql_idate="select * from elec_sub_department where insert_date='".date('Y-m-d')."' and $PageKey='".$_GET[$PageKey]."'";
...
if(isset($_POST["btn_submit"]))
{
	...
	else
	{
		...
		{					
			$tableName="elec_sub_department";
			$tableColumns=array("sub_department_id","department_id","name");
...
if(isset($_POST["btn_delete"]))
{
	...
	$sql = "delete from elec_sub_department where $PageKey = '".$PageKeyValue."'";
...
{
	$sql = "select * from elec_sub_department where $PageKey = '".$_GET[$PageKey]."'";
...
{
	$sql_code="select max(sub_department_id) as sub_department_id from elec_sub_department";
	$res_code=mysql_query($sql_code);
	$row_code=mysql_fetch_array($res_code);
	$sub_department_id=($row_code['sub_department_id']+1);
}
?>
                ...
                <td align="center" class="border">
                  ...
                  <form id="frm_add" name="frm_add"  method="post">
                    <table align="center" cellpadding="1" cellspacing="1" bgcolor="#EAE3E1" border="0" width="60%" class="text_1">
                      <tr>
                        <td align="left"><b>Sub Department Id</b></td>
                        <td align="left">
                          <input type="text" id="sub_department_id" name="sub_department_id" value="<?= $sub_department_id ?>" />
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="left"><b>Sub Department Name</b></td>
                        <td align="left">
                  ...
                  <div id="div_category_list"  style="overflow:auto;height:800px;margin-top:20px;">
                    <table align="left" width="100%" border="1" class="table1 text_1">
                      <tr>
                        ...
                        <td class="gredBg">Sub Department Name</td>
                        <td class="gredBg">Department</td>
                        <td class="gredBg">Edit</td>
                        <td class="gredBg">Delete</td>
                      </tr>
                    <?
                    $sql = "select * from  elec_sub_department order by name";
                    ...
                    if(mysql_num_rows($result)>0)
                    {
                      $sno=1;
												...
												{ 
												$sql_idate="select * from elec_sub_department where insert_date='".date('Y-m-d')."' and department_id='".$row['sub_department_id']."'";
												$res_idate=mysql_query($sql_idate);
												...
												<tr bgcolor="#F2F7F9">
													...
													?>
														<td align="center">
															<a href="elec_add_sub_department.php?sub_department_id=<?=$row['sub_department_id']?>&mode=edit"title="Edit" >
																<img src="images/icon_edit.gif" alt="Edit" border="0" />
															</a>
														</td>
														<td align="center">
															<a href="javascript:;" onClick="overlay(<?=$row["sub_department_id"]?>);" title="Delete" >

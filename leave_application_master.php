...
//$wife_occupation  ="";		
          ...
          if (isset($_SESSION['emp_family'])) {
              ...
              if (mysql_num_rows($result) > 0) {
                  ...
                  for ($i = 0; $i < $count; $i++) {
                      $child_name = $row['child_name'][$i];
                      $child_gender = $row['child_gender' . $i][0];
                      $child_dependent = $row['child_dependent' . $i][0];
                      $child_dob = $row['child_dob'][$i];
                  }
                  //end here
              }
          }
...
///End here   //
	...
	pf_deduction = '$pf_deduction',	bonus_rate='$bonus_rate',esic_applicable='$esic_applicable',esic_number ='$esic_no',esic_nominee ='$esic_nominee',esic_rate ='$esic_rate',esic_rate_employer='$esic_rate_employer',esic_relationship ='$esic_relationship',
																	InsertBy ='$pf_no',
																	InsertDate =now(),
																	IpAddress ='$ip',
																	payment_mode ='$payment_mode',
...
//End here
                  ...
                  $sql_check1 = "update " . $mysql_table_prefix . "shift_detail set	
																to_date  =now()
																where emp_id='$test' and to_date ='0000-00-00'";
          ...
          if (isset($_POST['emp_family'])) {
              ...
              if ($_POST['no_refresh'] == $_SESSION['no_refresh']) {
                  ...
                  if ($emp_family_edit == "") {
                      ...
                      //die();//Removed the attribute father_qualification='$father_qualification',father_occupation = '$father_occupation',mother_occupation = '$mother_occupation',mother_qualification='$mother_qualification',wife_qualification='$wife_qualification',
...
//Remove the following atteribut from the following...father_qualification='$father_qualification',father_occupation = '$father_occupation',mother_occupation = '$mother_occupation',mother_qualification='$mother_qualification',wife_qualification='$wife_qualification',wife_occupation = '$wife_occupation'
          ...
          if (isset($_POST['emp_education'])) {
              if ($_POST['no_refresh'] == $_SESSION['no_refresh']) {
                  ...
                  echo $hscsubject = $_POST['hscsubject'];
                  ...
                  echo '<pre>';
                  print_r($hscsubject);
                  echo $hscsubject = implode(",", $hscsubject);
...
'$site_allowance',
                  ...
                  $sql_insert_education = "update " . $mysql_table_prefix . "salary_master set 
                                           basic = '$basic',hra = '$hra',convence = '$convence',
                                           side_allowance = '$side_allowance',phone='$phone',
                                           tds = '$tds',other_deductions = '$other_gain',
                                           site_allowance=$site_allowance',
                                           medical = '$medical',gratuity='$gratuity',
                                            professional_tax = '$p_tax',from_date = now(),
                                                InsertBy = '',InsertDate = now(),
                                                IpAddress = '',celling ='$celling'
                        ...
                        <td style="vertical-align:top; padding-top:5px;">
                            ...
                            <div class="simpleTabs">
                                <ul class="simpleTabsNavigation">
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?>href="employee_detail.php?mode=" <?
                                        } if ($mode == '') {
                                            echo 'class="current"';
                                        }
                                        ?>>Personal Detail</a></li>
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?> href="employee_detail.php?mode=personal_detail"<?
                                        } if ($mode == 'personal_detail') {
                                            echo 'class="current"';
                                        }
                                        ?>>Family Detail</a></li>
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?> href="employee_detail.php?mode=family_detail"<?
                                        } if ($mode == 'family_detail') {
                                            echo 'class="current"';
                                        }
                                        ?>>Acadamic Information</a></li>
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?> href="employee_detail.php?mode=education_detail"<?
                                        } if ($mode == 'education_detail') {
                                            echo 'class="current"';
                                        }
                                        ?>>Experience Detail</a></li>
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?> href="employee_detail.php?mode=experience_detail"<?
                                        } if ($mode == 'experience_detail') {
                                            echo 'class="current"';
                                        }
                                        ?>>Official Profile</a></li>
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?>href="employee_detail.php?mode=offical_profile"<?
                                        } if ($mode == 'offical_profile') {
                                            echo 'class="current"';
                                        }
                                        ?>>Salary details</a></li>
                                    <li><a <? if (isset($_SESSION['emp_id']) or isset($_GET['emp_id'])) { ?>href="employee_detail.php?mode=salary_details"<?
                                        ...
                                        <tr>
                                            <td width="100%" colspan="2" align="center"><table cellpadding="0" cellspacing="0" border="0" align="center" class="loginbg">
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" name="empType" id="empStaff" value="1" <?php
                                                            if (@$empType == 'Staff') {
                                                                echo 'checked="checked"';
                                                            }
                                                            ?> required/>
                                                            <label for="empStaff">Staff</label>
                                                            <input type="radio" name="empType" id="empWorker" value="2" <?php
                                                            if (@$empType == 'worker') {
                                                                echo 'checked="checked"';
                                                            }
                                                            ?> required />
                                                        ...
                                                        <td width=""><!--<input type="text" name="emp_login" id="emp_login" readonly="readonly" style="width:150px; height:20px;" value="<?= @$emp_id ?>">-->
                                                            ...
                                                            if (isset($_SESSION['emp_id'])) {
                                                                ...
                                                                echo 'readonly="readonly"';
                                                                ?> onBlur="check_login_id(this.value);"<? } ?>></td>

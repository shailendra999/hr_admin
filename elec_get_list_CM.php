...
if($val!='')
{
	...
	$DateRange="(CM_date BETWEEN '".$dfrom."' and '".$dto."')";
	$Department="and department_id='".$department_id."'";
	$Machine="and machine_id='".$machine_id."'";
}
	$sql="select * from elec_CM where (CM_date >='".$dfrom."' and CM_date <='".$dto."') and department_id='".$department_id."' and  machine_id='".$machine_id."'";

$sql="select * from elec_CM where 
$DateRange
$Department
$Machine
";
...
<div class="AddMore" style="padding-top:10px">
	<form action="elec_print_list_CM.php" name="test" id="test" method="post" target="_blank"> 

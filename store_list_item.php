...
function getItemsByName(divId,page)
{	
	var strURL1=page;
	var params = "item_name="+document.getElementById('item_name').value+"&department_id="+document.getElementById('department_id').value+"&machinary_id="+document.getElementById('machinary_id').value+"&drawingNo="+document.getElementById('drawingNo').value+"&catelogNo="+document.getElementById('catelogNo').value;
...
if(isset($_POST["btn_del"]))
{
	...
	$sql_sel="select * from ms_indent_transaction where item_id='".$PageKeyValue."'";
	$res_sel=mysql_query($sql_sel) or die("Invalid query : ".$sql_sel."<br>".mysql_errno()." : ".mysql_error());
	if(mysql_num_rows($res_sel)>0)
	{
		$Message="Item Not Deleted.";
		$URL="$Page?Message=$Message";
		echo "<script>alert('Sorry!!!Indent is Made for this Item.');location.href='$URL';</script>";
	}
	else
	{
                 ...
                 <table id="" align="center" width="100%" border="1" class="table1 text_1">
                    ...
                    <tr>
                      ...
                      <td colspan="3" align="left">
                      	<select id="item_name" name="item_name" style="width:50px; font-size:10px;" onchange="getItemsByName('getItemsInDiv','store_get_list_item.php')">
                     ...
                     <tr>
                      ...
                      <td width="35%">
                   	  <select id="department_id" name="department_id" style="width:150px" onchange="getItemsByName('getItemsInDiv','store_get_list_item.php')">
                        	<option value="">-Select-</option>
													<?
                      ...
                      <td width="21%"><b>Machinary</b></td>
                      <td width="29%">
                      	<select id="machinary_id" name="machinary_id" style="width:150px" onchange="getItemsByName('getItemsInDiv','store_get_list_item.php')">
                          <option value="">-Select-</option>
                          <?
                    ...
                    <tr>
                      ...
                      <td>
                    		<input type="text" id="drawingNo" name="drawingNo" style="width:150px" onkeyup="getItemsByName('getItemsInDiv','store_get_list_item.php')"/>
                      </td>
                      <td><b>Catelog Number</b></td>
                      <td>
                    		<input type="text" id="catelogNo" name="catelogNo" style="width:150px" onkeyup="getItemsByName('getItemsInDiv','store_get_list_item.php')"/>
                      </td>
                    </tr>
                  </table>
                  <div id="getItemsInDiv" style="margin:0 auto;width:100%;overflow:auto;height:600px">

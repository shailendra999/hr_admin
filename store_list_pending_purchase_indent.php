...
function getDataInDiv(value,divId,page,byControl){
	...
	if(value!=''){
		var strURL1=page+"?value="+value+"&byControl="+byControl+"&Pending=1&finYear="+finYear;;
		//alert(strURL1);
		var req = getXMLHTTP();
		if (req)
		{																					
...
$sql="select * from ms_indent_master mim,ms_indent_transaction mit where mim.indent_id=mit.indent_id and pend_qty!=0 order by mim.indent_date asc";
      ...
      <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
        	<td align="center" class="gray_bg">
          	<img src="images/bullet.gif" width="15" height="22"/> &nbsp; List Pending Purchase Indent
          </td>
        </tr>
        <tr>
          <td valign="top">
            <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr>
                <td align="center" class="border">
                  ...
                  <table align="center" width="100%" border="1" class="table1 text_1 tnb_print">
                    <tr>
                      <td align="center" colspan="4"><b>Search Items</b></td>
                    </tr>
					<tr>
                      <td align="left"><b>Financial Year</b></td>
                      <td align="left">
					  	<select name="finYear" id="finYear" style="width:150px;height:20px" >
							<option value="0">-- Select All --</option>
<? $sql_finYear= 'select distinct finYear from ms_indent_master';
	$res_finYear = mysql_query ($sql_finYear) or die (mysql_error());
	if(mysql_num_rows($res_finYear)>0){
		while($row_finYear = mysql_fetch_array($res_finYear)){ ?>
							<option value='<?=$row_finYear['finYear'];?>' <? if($row_finYear['finYear'] == $gFinYear) echo 'selected="selected"';?> ><?= $row_finYear['finYear'];?></option>
		<? }
	}?>
                        </select>
					  </td>
            ...
            <option value="<?= $row_I['item_id']?>"><?= $row_I['name'].' | Drg No. '.$row_I['drawing_number'].'  | Cat. No.'.$row_I['catelog_number']?></option>
                  	...
                  	<div id="getItemsInDiv" style="margin:0 auto;width:100%;">

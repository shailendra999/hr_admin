...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td align="left" style="padding-top:5px;" colspan="2">
            <table cellpadding="0" cellspacing="0" border="0" align="left" class="loginbg" width="98%">
                <tr>
                    <td width="12%" style="padding-left:15px;">Employee List<span class="red">*</span></td>
                    ...
                    <td width="13%">
                        <input type="text" id="emp_search" name="emp_search" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                    get_frm_menu('employee_list.php', this.value, 'emp_list', '');
                                }" value="<?= $ticket_no ?>"/>
                    </td>
                    <td width="72%" style="padding-top:5px;">
                        <form name="frm_check" id="frm_check">
                            ...
                            <input type="radio" id="search_by" name="search_by"  value="Name" onclick="get_frm_menu('employee_list.php', document.getElementById('emp_search').value, 'emp_list', '')"/>Employee Name
                            <input type="radio" id="search_by" name="search_by"  value="Employee" onclick="get_frm_menu('employee_list.php', document.getElementById('emp_search').value, 'emp_list', '')"/>Department Name
                        </form>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td id="td_data" align="left" class="menuLink" style=" padding-top:10px;" width="200px" valign="top">
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    function last_msg_funtion()
                    {
                        ...
                        $.post("load/load_data.php?action=get&last_msg_id=" + ID,
                                function (data) {
                                    if (data != "") {
            ...
            <? $action = ""; ?>
            <div id="emp_list" style="overflow:scroll;height:350px;width:600px;">
                <?php include('load/load_first.php'); ?>

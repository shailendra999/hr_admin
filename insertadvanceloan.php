...
if (isset($_POST['issuse_loan'])) {
    ...
    $sql_check = "insert into  " . $mysql_table_prefix . "loan_employee set	
																emp_id  ='$emp_id',
																loan_amount ='$issuse_loan',
																installments_decided ='$decide_install',
																loan_date =now()";
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                <tr>
                    <td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Advance/Loan-> </a>insert loan/advance</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                            <tr>
                                <td valign="top">
                                    <? include("list_employeeloan_ajax.php"); ?>
                                </td>
                            </tr>
                        </table>
                    </td>

...
<div <? if($mode=='personal_detail'){ echo 'class="current"';}else{echo 'class="simpleTabsContent"';} ?>>
      <form name="empolyee_family" id="empolyee_family" action="employee_detail.php" method="post" enctype="multipart/form-data" onSubmit="return valid_customer(this);">
        <table align="center" width="100%" cellpadding="2" cellspacing="2" class="border" border="0" style="padding-top:10px" height="472px">
          <tr>
            <td width="50%" valign="top"><table align="center" width="100%" cellpadding="2" cellspacing="2" class="border">
                <tr>
                  ...
                  <td align="left" width="65%"><input type="text" name="father_name" id="father_name" style="width:210px; height:26px;" value="<?=$father_name?>" required /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input type="text" name="mother_name" id="mother_name" style="width:210px; height:26px;" value="<?=$mother_name?>" required /></td>
                </tr>
                <tr>
                  <td class="text_1">Depended</td>
            ...
            <td width="50%" valign="top"><table align="center" width="100%" cellpadding="2" cellspacing="2" class="border">
                <tr>
                  ...
                  <td align="left" width="65%"><input type="text" name="father_dob" id="father_dob" style="width:210px; height:26px;" value="<?=$father_dob?>" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']" />
                    </td>
                </tr>
                <tr>
                  <td class="text_1">Father Qualification</td>
                  <td align="left"><input type="text" name="father_qualification" id="father_qualification" style="width:210px; height:26px;" value="<?=$father_qualification?>"/></td>
                </tr>
                <tr>
                  <td class="text_1">Occupation</td>
                  <td align="left"><input type="text" name="father_occupation" id="father_occupation" style="width:210px; height:26px;" value="<?=$father_occupation?>"/></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input type="text" name="mother_qualification" id="mother_qualification" style="width:150px; height:20px;" value="<?=$mother_qualification?>" style="width:210px; height:26px;"/></td>
                </tr>
                <tr>
                  <td class="text_1">Occupation</td>
                  <td align="left"><input type="text" name="mother_occupation" id="mother_occupation" style="width:150px; height:20px;" value="<?=$mother_occupation?>" style="width:210px; height:26px;"/></td>
                </tr>
                <?php   if($_SESSION['marital_sta'] === 'yes'){ ?>
                <tr>
                  <td class="text_1">Spouse DOB </td>
                  <td align="left"><input type="text" name="wife_dob" id="wife_dob" style="width:210px; height:26px;" value="<?=$wife_dob?>" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']" />
                    </td>
                </tr>
                <tr>
                  <td class="text_1">Spouse Qualification</td>
                  <td align="left"><input type="text" name="wife_qualification" id="wife_qualification" style="width:150px; height:20px;" value="<?=$wife_qualification?>" style="width:210px; height:26px;"/></td>
                </tr>
               <td class="text_1">Occupation</td>
                  <td align="left"><input type="text" name="wife_occupation" id="wife_occupation" value="<?=$wife_occupation?>" style="width:210px; height:26px;"/></td>
                </tr>
                <?php } ?>
              </table></td>
          </tr>

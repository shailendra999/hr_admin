<script language="javascript">
    function addElement(td1, td2, td3, td4) {
        var td1 = document.getElementById(td1);
        var td2 = document.getElementById(td2);
        var td3 = document.getElementById(td3);
        var td4 = document.getElementById(td4);
        alert(td1.innerHTML + td2.innerHTML + td3.innerHTML + td4.innerHTML);
    }
                    ...
                    <td align="left" colspan="3" style="padding-top:3px;">
                        <table align="left" width="100%" cellpadding="1" cellspacing="1" class="border" border="0">
                            ...
                            for ($i = 0; $i <= $count; $i++) {
                                ...
                                <table id="dataTable">
                                    <tr>
                                        <td align="left" width="24%" id="child_name_td">
                                            <input name="child_name[]" id="child_name[]" type="text"  value="<?= $child_name[$i] ?>"  style="width:180px; height:20px;"/>
                                        </td>
                                        <td align="left"width="24%" id="child_gender_td">
                                            <label>
                                                <input type="radio" name="child_gender[]" id="child_gender"   value="male"/>
                                                Male
                                            </label>
                                            <label>
                                                <input name="child_gender[]" id="gen" type="radio" value="female"/>
                                                Female
                                            </label>
                                        </td>
                                        <td align="left" width="24%" id="child_dep_td">
                                        ...
                                        <td align="left" width="24%" id="child_dob_td">
                                            <input name="child_dob[]" id="child_dob[]" type="text" value="">
                                        </td>
                                        <td class="AddMore" style="padding-right:10px;" width="24%">
                                        </td>
                                    <input type="button" value="Add Row" onclick="addRow('dataTable'), addElement('child_name_td', 'child_gender_td', 'child_dep_td', 'child_dob_td')">

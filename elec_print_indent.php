                ...
                if($rc_trans>0)
                {
                  ...
                  <tr class="particulars">
                    ...
                    <td align="left" style="padding-left:5px;" class="borderRight" valign="top">
                      ...
                      echo "<div style='height:30px;overflow:hidden;padding:0px'>".$row_item['name']."</div>";
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                     <tr>
                      ...
                      <tr>
                        <td width="22%" align="left">Dept Head</td>
                        <td width="29%" align="center">Store Incharge</td>
                        <td width="20%" align="center">DGM</td>
                        <td width="29%" align="right">GM   &nbsp;</td>
                      </tr>
                    </table>
                  </td>
                </tr>

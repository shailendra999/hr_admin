    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                <tr>
                    <td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Report-> </a>bonus & exgratia report</td>
                </tr>
                <tr>
                    <td valign="top">
                                                        ...
                                                        <td style="padding-top:10px;" align="center">
                                                            <form name="frm_month" id="frm_month" action="" method="post">
                                                                <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td class="text_1" style="text-align:left;">
                                                                            <?
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="6" align="center" style="padding-top:5px;">
                                                                            ...
                                                                            <a href="javascript:;" onclick="document.location = 'bonus_exgratia_report.php';">
                                                ...
                                                <table align="center" width="100%" cellpadding="1" cellspacing="1" border="0" style="border:1px solid #E4E4E4;">
                                                    ...
                                                    if (isset($_POST["btn_submit_x"]) or isset($_GET['month'])) {
                                                        if (mysql_num_rows($result_prj) > 0) {
                                                            ...
                                                            <tr>
                                                                <td align="right">
                                                                    <form action="print_bonus_exgratia_report.php" method="post" name="frm_print" id="frm_print" target="_blank">
                                                                    ...
                                                                    <div id="div_attandance_list" style="overflow:scroll;height:500px;width:1000px">
                                                                        <table align="center" width="100%" cellpadding="0" cellspacing="0" class="table1" border="1">
                                                                            <tr class="gredBg">
                                                                                ...
                                                                                <td width="15%" align="center"><b>Month</b></td>
                                                                                <td align="center"><b>Earning<br/></b></td>
                                                                                <td align="center"><b>Bonus Amount</b></td>
                                                                                <td align="center"><b>Ex-gratia</b></td>
                                                                            </tr>
                                                                            <?
                                                                            while ($row = mysql_fetch_array($result_prj)) {
                                                                                ...
                                                                                <tr <? if ($sno % 2 == 1) { ?> bgcolor="#F8F8F8" <? } ?> class="tableTxt">
                                                                                    ...
                                                                                    <td width="5%" align="left" colspan="5">

...
$from_date="";
$id = $_POST['str11'];
$sql = "SELECT celling FROM  mpc_salary_master where emp_id  = '$id' and to_date='0000-00-00'";
...
<table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
    ...
    <tr>
        ...
        <td>
            <table width="100%" cellpadding="2" cellspacing="2" align="center" border="0">
                <tr>
                                                        <?php   	if($celling == 'yes'){	$pf=(getAccountDetail('pf_rate',$id)*6500)/100;} 
	else { $pf=(getAccountDetail('pf_rate',$id)*$basic)/100;}  ?>


                    <td width="50%" class="text_1">PF</td>
                    <td width="50%"><?php echo round($pf);?></td>
              </tr>
                <tr>
...
<table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" class="border">
 ...
 <input type="hidden" name="cellin_val" id="cellin_val" value="<?=$celling?>"/> 
               <?php   	if($celling == 'yes'){	$pf=(getAccountDetail('pf_rate',$id)*6500)/100;} 
	else { $pf=(getAccountDetail('pf_rate',$id)*$basic)/100;}  ?>

					
					<input type="text" name="pf_value" id="pf_value" style="width:180px; height:20px;" value="<?php echo round($pf);?>" disabled="disabled"/></td>
              </tr>
                <tr>
                    <td class="text_1">ESI</td>
                    <td>

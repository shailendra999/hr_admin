    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                <tr>
                    <td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Salary master-> </a>salary deduction</td>        
                </tr>
                <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="E_salary">
                                                    <table>
                                                        <tr>
                                                            <td width="5%" align="left" class="text_1">Year</td>
                                                        ...
                                                        <tr>
                                                            <td class="text_1">Employee List</td>
                                                            <td>

                                                                <input type="text" id="emp_search" name="emp_search" onkeydown="if (event.keyCode && event.keyCode == 13) {
                                                                            get_frm_menu('employee_list_deduction.php', this.value, 'emp_list', '');
                                                                        }" value="<?= $ticket_no ?>"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="24%" class="text_1" style="padding-top:5px;">
                                                                <form name="frm_check" id="frm_check">
                                                                    <input type="radio" id="search_by" name="search_by" value="ID" checked="checked" onclick="get_frm_menu('employee_list_deduction.php', document.getElementById('emp_search').value, 'emp_list', '')" style="margin:0 5px 0 0;" />ID
                                                                    <input type="radio" id="search_by" name="search_by"  value="Name" onclick="get_frm_menu('employee_list_deduction.php', document.getElementById('emp_search').value, 'emp_list', '')" style="margin:0 5px 0 0;"/>Name
                                                                    <input type="radio" id="search_by" name="search_by"  value="Employee" onclick="get_frm_menu('employee_list_deduction.php', document.getElementById('emp_search').value, 'emp_list', '')"/>Department Name

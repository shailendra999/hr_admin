                ...
                <td align="center" class="border">
                  ...
                  <table align="center" width="100%" border="1" class="table1 text_1">
                    ...
                    <tr>
                      ...
                      <td align="left">
                        <input type="text" name="itemIndentSearch" id="itemIndentSearch" onKeyUp="getDataInDiv(this.value,'getItemsInDiv','maint_get_list_indent.php','IndentNo')" />
                      </td>
                      ...
                      <td align="left">
                        ...
                        <input type="button" id="btnOk" name="btnOk" value="Ok" onClick="getDataInDiv('','getItemsInDiv','maint_get_list_indent.php','IndentDate')"/>
                      </td>
                     </tr>
                      <td align="left"><b>Department</b></td>
                      <td align="left">
                      	<select name="department_id" id="department_id" style="width:150px;height:20px" onChange="getDataInDiv(this.value,'getItemsInDiv','maint_get_list_indent.php','Department')" >
                      ...
                      <td align="left">
                      	<select name="item_id" id="item_id" style="width:150px;height:20px" onChange="getDataInDiv(this.value,'getItemsInDiv','maint_get_list_indent.php','Item')" >
                          <option value="0"></option>
                          <? 

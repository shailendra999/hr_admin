...
if(isset($_POST["btn_submit"]))
{
	...
	$buyer_date = getDateFormate($_POST['buyer_date']);
	
	if($PageKeyValue == "")
	{
		$tablename="ms_buyer_master";
		$tableData=array("''","'$company_id'","'$purchaser_id'","'$form_id'","'$product_id'","'$quantity'","'$buyer_date'","now()","$SessionLoginMasterId");
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/>&nbsp; Add Buy</td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td align="center" class="border">
                                    <div align="center" style="min-height:470px; padding-top:15px;">
                                        ...
                                        <form id="purchase_frm_buy" name="purchase_frm_buy" action="" method="post">
                                            <table align="center" cellpadding="1" cellspacing="1" border="0" width="60%" style="border:#CCCCCC solid 1px;">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td align="left" bgcolor="#F2F7F9" width="60%" style="padding-left:10px;">
                                                    <input type="text" id="buyer_date" name="buyer_date"  />
                                                      <a href="javascript:void(0)" onClick="gfPop.fPopCalendar(document.purchase_frm_buy.buyer_date);return false;" HIDEFOCUS>

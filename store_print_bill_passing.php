...
<title>Print Bill Passing</title>
<style>
.note
{
              ...
              <table align="center" width="100%" border="0" cellspacing="0" cellpadding="2" class="tblborder">
                <tr>
                  <td align="center" class="borderTop borderBottom">
                    <b style="font-size:20px">BILL PASS</b>
                  </td>
                </tr>
                <tr>
                  <td align="center" class="borderBottom">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        <td align="left" width="25%"><b>Bill No.:</b></td>
                        <td align="left" width="25%" class="borderRight"><?= $bill_pass_id ?></td>
                        <td align="left" width="25%"><b>Bill Date :</b></td>
                        <td align="left" width="25%"><?= $bill_pass_date ?></td>
                      </tr>
                      <tr>
                        <td align="left" width="25%"><b>GRN No.:</b></td>
                        <td align="left" width="25%" class="borderRight"><?= $GRN_id ?></td>
                        <td align="left" width="25%"><b>GRN Date :</b></td>

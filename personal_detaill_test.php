...
<table>
    <tr>
        <td valign="top">
            <table width="100%" cellpadding="2" cellspacing="2" class="border" border="0" height="707px">
                <tr>
                    ...
                    <?php if (!empty($employee_picture)) { ?>
                        <td><img src="<?php echo "http://solutionsofts.com/lss/" ?>employee_picture/thumb/<?php echo $employee_picture; ?>"></td>
                    <?php } ?>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="text_1" valign="top">correspondence</td>
                ...
                <tr>
                    ...
                    <td align="left"><?php
                        ...
                        ?>
                        <select name="country" id="country" onChange="getState(this.value);" style="width:200px;">
                            <option value="">-select country-</option>
                            <?
                            while ($row = mysql_fetch_array($result)) {
                                ?>
                                <option value="<?php echo $row['countries_id'] ?>" <? if ($row['countries_id'] == $country) { ?> selected="selected" <? } ?>>
                                    <?= $row["countries_name"] ?>
                                </option>
                            <? } ?>
                        </select></td>
        ...
        <td width="50%" valign="top"><table align="center" width="100%" cellpadding="2" cellspacing="2" class="border" border="0" height="100%">
                <?php /* ?><tr>
                  <td width="43%" class="text_1">Gender</td>
                  <td width="57%" align="left" class="text_1" style="padding-left:0px;"><input type="radio" id="gender" name="gender" value="Male" <? if($gender=='male') {?>checked="checked"<? }?>/>
                  Male
                ...
                <tr>
                <tr>
                    <td class="text_1">Emergency Contact No.</td>
                ...
                <tr>
                    ...
                    <td align="left"><input type="email" name="email_id" id="email_id" style="width:150px; height:20px;" value="<?= $email_id ?>" /></td>
                </tr>

                <tr>
                    <td class="text_1">Email Id Official</td>
                    <td align="left"><input type="email" name="email_official" id="email_official" style="width:150px; height:20px;" value="<?= $email_official ?>"/></td>
                </tr>
                <tr>
                ...
                <tr id="ss">
                    ...
                    <td align="left"><input type="text" name="marr_date" id="marr_date" disabled="disabled" style="width:150px; height:20px;" value="<?= $marriage_date ?>" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left"><textarea name="habit" style="width:150px; height:64px;"><?= $habit ?>
                        </textarea></td>
                </tr>
...
<script>
    function getState(cid) {
        ...
        document.getElementById('div_add_state').innerHTML = "<img src='images/ajax_loader.gif'>";
...
//                alert(xmlHttp.responseText);
                document.getElementById("div_add_state").innerHTML = xmlHttp.responseText;
            }
        };
...
//        alert(sid);
        ...
        document.getElementById('div_city').innerHTML = '<img src="images/ajax_loader.gif" border="0">';

        var url = "get_city_reg.php";
        url = url + "?id=" + sid + "&str=" + "city_select";
        url = url + "&sid=" + Math.random();
        xmlHttp1.onreadystatechange = function ()
        {
            if (xmlHttp1.readyState == 4 || xmlHttp1.readyState == "complete")
            {
                document.getElementById('div_city').innerHTML = xmlHttp1.responseText;
            }
        };

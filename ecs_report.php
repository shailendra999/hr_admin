    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                <tr>
                    <td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Report-> </a>ECS Report Employee</td>
                </tr>
                <tr>
                    <td valign="top">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td>
                                                                            <form action="print_ecs_report.php" method="post" name="frm_print" id="frm_print" target="_blank">
                                                                        ...
                                                                        <td valign="top">
                                                                            <form action="xls_ecs_report.php" method="post" name="frm_print_xls" id="frm_print_xls" target="_blank" style="display:inline;">
                                                                                <input type="hidden" name="print_month" id="print_month" value="<?= $month ?>"/>
                                                                                <input type="hidden" name="print_year" id="print_year" value="<?= $year ?>"/>
                                                                                <input type="hidden" name="print_employee_type" id="print_employee_type" value="<?= $employee_type ?>"/>
                                                                                <input type="hidden" name="print_ticket_id" id="print_ticket_id" value="<?= $ticket_id ?>"/>
                                                                ...
                                                                <div id="div_attandance_list" style="overflow:scroll;height:500px;width:1000px">
                                                                    <table align="center" width="100%" cellpadding="0" cellspacing="0" class="table1" border="1">
                                                                        <tr class="gredBg">
                                                                            ...
                                                                            <td width="15%" align="center"><b>Account No.</b></td>
                                                                            <td width="15%" align="center"><b>ECS Payment</b></td>
                                                                            <td align="center"><b>OT ECS Payment</b></td>
                                                                            <td align="center"><b>Total ECS Payment</b></td>
                                                                            <td align="center"><b>Bank Name </b></td>
                                                                            <td align="center"><b>Remark</b></td>
                                                                            <td align="center"><b>PF</b></td>
                                                                            <td align="center"><b>ESIC</b></td>
                                                                            <td align="center"><b>ECS Payment </b></td>
                                                                            <?php
                                                                            if (isset($_REQUEST['over_time'])) {
                                                                                ?>
                                                                        ...
                                                                        while ($result_emp_master = mysql_fetch_array($run_emp)) {
                                                                            ...
                                                                            $select_plant = mysql_query("Select * from mpc_plant_master,mpc_plant_employee where mpc_plant_master.rec_id = mpc_plant_employee.plant_id AND mpc_plant_employee.emp_id = $emp_id");
                                                                            $fetchplant = mysql_fetch_array($select_plant);
                                                                            $plant_name = $fetchplant['plant_name'];
...
//                                                                                echo $tot_arrear;
                                                                                ...
                                                                                <tr <? if ($sno % 2 == 1) { ?> bgcolor="#F8F8F8" <? } ?> class="tableTxt">
                                                                                    ...
                                                                                    <td width="5%" align="center"><?= $emp_token ?></td>
                                                                                    ...
                                                                                    <td align="center">
                                                                                        <? round($tot_sal = $total_other_allowance + $tot_arrear + $total_salary_basic + $total_hra + $total_convence + $side_allowance + $total_phone + $total_site) ?>
                                                                                        <?= $payable = $tot_sal - ($total_pf + $total_esi) ?>
                                                                                    </td>
                                                                                    <td align="center">
                                                                                        <?= round($tot_ot) ?>
                                                                                    </td>
                                                                                    <td align="center">
                                                                                        <?= round($ecs_pay = $tot_ot + $payable) ?>
                                                                                    </td>
                                                                                    <td align="center">
                                                                                        <?= $bank_name ?>
                                                                                    </td>
                                                                                ...
                                                                                <?
                                                                                $sno++;
                                                                                $grand_total = $payable + $grand_total;
                                                                                $grand_ot = $tot_ot + $grand_ot;
                                                                                $grand_ecs = $ecs_pay + $grand_ecs;
                                                                                $grand_pf = $total_pf + $grand_pf;
                                                                                $grand_esi = $total_esi + $grand_esi;
//                                                                                $grand_pay = $grand_pay + $payable;
                                                                            }
                                                                        }
                                                                        ?>

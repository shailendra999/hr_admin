...
$sql="select mm.RGP_id,mm.RGP_date,mm.supplier_id,mt.item_name,mt.quantity,mt.pend_qty, mm.finYear from ms_RGP_master mm,ms_RGP_transaction mt where mm.RGP_id=mt.RGP_id and mt.pend_qty>0 order by mm.RGP_id asc";
      	...
      	<table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
        	<tr>
          	<td align="center" class="gray_bg">
            	<img src="images/bullet.gif" width="15" height="22"/> &nbsp; List RGP Pending
            </td>
          </tr>
          <tr>
          	<td valign="top">
                     ...
                     <div id="div_message" style="color:#399;font-size:16px;font-weight:bold;"><?=$Message?></div>
                      <table align="center" width="100%" border="1" class="table1 text_1">
                        ...
                        <tr>
                          ...
                          <td align="left">
                            <input type="text" name="RGP_id" id="RGP_id" onkeyup="getDataInDiv('getItemsInDiv','store_get_list_RGP_Pending.php')" />
                          </td>
                          <td align="left"><b>Supplier</b></td>
                          <td align="left">
                          <select name="supplier_id" id="supplier_id" style="width:145px;" onchange="getDataInDiv('getItemsInDiv','store_get_list_RGP_Pending.php')">
                         ...
                         <tr>
                          ...
                          <td align="left">
                          <input name="item_id" id="item_id" type="text" style="width:145px;" onkeyup="getDataInDiv('getItemsInDiv','store_get_list_RGP_Pending.php')"/>
                          </td>
                        </tr>
                        <tr>
                        	<td align="left"><b>Department</b></td>
                          <td align="left" colspan="3">
                          <select name="department_id" id="department_id" style="width:145px;" onchange="getDataInDiv('getItemsInDiv','store_get_list_RGP_Pending.php')">
                              <option value="">-Select-</option>
                              <?
                        ...
                        <tr>
                        	<td colspan="4" align="center">
                            	<input type="button" id="btnOk" name="btnOk" value="Ok" onclick="getDataInDiv('getItemsInDiv','store_get_list_RGP_Pending.php')"/>
                            </td>
                        </tr>
                      </table>

...
if (isset($_POST["btn_submit"])) {
    ...
    if ($PageKeyValue == "") {
        $sql = "insert into mpc_holiday_master set holiday_name  = '$holiday_name',holiday_date  = '$holiday_Date'";
        mysql_query($sql) or die("Error in " . $sql . "<br>" . mysql_errno() . " : " . mysql_error());
        $Message = "$PageFor Inserted";
    } else {
        if ($mode != "subcategory") {
            $sql = "update mpc_holiday_master set holiday_name  = '$holiday_name',
			holiday_date  = '$holiday_Date'where $PageKey = '$PageKeyValue'";
            mysql_query($sql) or die("Error in " . $sql . "<br>" . mysql_errno() . " : " . mysql_error());
...
if (isset($_GET[$PageKey])) {
    ...
    if (mysql_num_rows($result) > 0) {
        ...
        $holliday_date = $row["holiday_date"];
    }
}
?>
                                    ...
                                    <div align="center" style="height:470px; padding-top:30px;">
                                            ...
                                            <table align="center" cellpadding="1" cellspacing="1" border="0" width="60%" style="border:#CCCCCC solid 1px;">
                                                <tr>
                                                    ...
                                                    <td align="left" bgcolor="#F2F7F9" style="padding-left:10px;">
                                                        <input type="text" name="holiday_name" id="holiday_name" value="<?php echo $Name; ?>"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="paas_text" bgcolor="#E2EBF0">Holiday Date</td>
                                                    <td align="left" bgcolor="#F2F7F9" style="padding-left:10px;">
                                                        <input type="text" name="holiday_Date" id="holiday_Date" value="<?php echo $holliday_date; ?>" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']"/>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="53%" align="left" bgcolor="#F2F7F9" style="padding-left:10px;">
                                                        ...
                                                        <select id="holiday" name="holiday" onchange="form.submit();">
                                                            ...
                                                            while ($row_prd = mysql_fetch_array($result_prd)) {
                                                                ?>
                                                                <option value="<?= $row_prd['Year'] ?>" <?
                                                                if ($year == $row_prd['Year']) {
                                        ...
                                        <div id="div_category_list"  style="overflow:scroll;height:300px;width:650px">
                                            <table align="center" width="80%" style="border:#CCCCCC solid 1px;" cellpadding="1" cellspacing="1">
                                                ...
                                                <?
                                                $sql = "select * from mpc_holiday_master where YEAR(holiday_date) ='$year' order by holiday_date";
                                                $result = mysql_query($sql) or die("Invalid query : " . $sql . "<br>" . mysql_errno() . " : " . mysql_error());
                                                if (mysql_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysql_fetch_array($result)) {
                                                        ...
                                                        <tr bgcolor="#F2F7F9">
                                                            ...
                                                            <td class="Text01"><?= date('d-m-Y', strtotime($row["holiday_date"])) ?></td>
                                                            <td class="Text01"><a href="add_holiday.php?rec_id=<?= $row['rec_id'] ?>&mode=edit">Edit</a></td>

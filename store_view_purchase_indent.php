      ...
      <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
      	<tr>
         	<td align="center" class="gray_bg">
          	<img src="images/bullet.gif" width="15" height="22"/> &nbsp; View Purchase Indent
          </td>
        </tr>
        <tr>
          <td valign="top" style="padding-top:10px;">
            <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="AddMore">
                   <a target="_blank" href="store_print_purchase_indent.php?indent_id=<?= $PageKeyValue?>" title="Print">Print&nbsp;&nbsp;&nbsp;</a>
                </td>
              </tr>
              <tr>
                          ...
                          <td>
                            ...
                            ?>
                                <tr class="text_tr" bgcolor="<?=$tableColor?>">
                                  ...
                                  <td align="center" width="15%"><b>UOM</b></td>
                                  <td align="center" width="25%"><b>Description</b></td>
                                </tr>
                                <tr class="text_tr" bgcolor="<?=$tableColor?>">
                                  <td align="center"><?=$countTrans?></td>
                                  <td align="center"><?=$item_id?></td>
                                  <td align="left" style="padding-left:3px"><?=$item_name?></td>                                	
                                  <td align="center"><?=$uname?></td>
                                  <td align="left" style="padding-left:3px"><?=$item_desc_trans?></td>
                                </tr>
                                <tr class="text_tr" bgcolor="<?=$tableColor?>">
                                ...
                                <tr class="text_tr" bgcolor="<?=$tableColor?>">
                                  ...
                                  <td align="left" style="padding-left:3px"><?=$row_o_t['remark']?></td>
                                  <td align="center"><?=getDateFormate($row_o_t['due_date'])?></td>
                                  <td align="left" style="padding-left:3px"><?=$row_o_t['purpose']?></td>
                                </tr>

...
if(isset($_POST['ded_id']))
{
	...
	$sql_up = "update mpc_advance_employee set 
												deduction = '$txt_deduction',
												deduction_date = '$txt_date',
	...
	if($result_up)
	{
		$msg="Advance Deduction Updated!!";
	}
	else
	{
		$msg="Error In Updating Advance Deduction!!";
	}
}
?>
<?
...
{			
	 $sql_prj = "select DAY(mpc_official_detail.date_joining) as 'Day',MONTH(mpc_official_detail.date_joining) as 'Month' ,YEAR(mpc_official_detail.date_joining) as 'Year',mpc_official_detail.date_joining,mpc_employee_master.rec_id as id,mpc_employee_master.ticket_no,mpc_employee_master.first_name,mpc_employee_master.last_name,mpc_official_detail.emp_id ,mpc_account_detail.emp_id,mpc_account_detail.date_releaving,mpc_advance_employee.deduction,mpc_advance_employee.deduction_date,mpc_advance_employee.rec_id as ded_id ,mpc_advance_employee.deduction_by $select_string from ".$mysql_table_prefix."employee_master,mpc_official_detail,mpc_account_detail,mpc_advance_employee $table_list where mpc_employee_master.rec_id!='' and mpc_employee_master.rec_id=mpc_official_detail.emp_id and EXTRACT(YEAR_MONTH FROM mpc_official_detail.date_joining)<='$year$month' and mpc_employee_master.rec_id=mpc_account_detail.emp_id and mpc_account_detail.date_releaving ='0000-00-00' and mpc_advance_employee.emp_id =  mpc_employee_master.rec_id $where_string and mpc_advance_employee.ad_date='0000-00-00' and mpc_advance_employee.deduction!='' and  MONTH(mpc_advance_employee.deduction_date)='".$month."' and YEAR(mpc_advance_employee.deduction_date) ='".$year."' order by mpc_employee_master.ticket_no ASC";
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Advance/Loan-> </a>adv deduction report</td>
                </tr>
                <tr>
                                                   ...
                                                   <tr>
                                                  		 <td align="right">
                                                         	<table cellpadding="0" cellspacing="0" border="0">
                                                            	<tr>
                                                                	<td>
                                                                        <form action="print_advance_deduction_list.php" method="post" name="frm_print" id="frm_print" target="_blank">
                                                      ...
                                                      <div id="div_attandance_list" style="overflow:scroll;height:500px;width:1000px">
                                                            <table align="center" width="100%" cellpadding="0" cellspacing="0" class="table1" border="1">
                                                              <tr class="gredBg">
                                                                ...
                                                                <td width="15%" align="center"><b>Advance Deduction</b></td>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td align="center"><a href="javascript:;" onClick="get_frm('edit_advance_deduction.php','<?=$row["ded_id"]?>','div_edit','')">
                                                                    	<img src="images/Modify.png" alt="Edit" title="Edit" border="0"></a></td>
                                                                <td align="center"><a href="javascript:;" onClick="overlay(<?=$row["ded_id"]?>);">

...
$ticket_id = $_GET["id"];
$type = $_GET["type"];
 $date1 = getdbDate($_GET["str"]);
 $date2 = getdbDate($_GET["sdate"]);
...
<!-- End here -->
    ...
    <?php  } ?>
     ...
     <!--End here-->
			<input type="button" src="images/btn_submit.png" name="btn_attend" id="btn_attend" value="Submit" onclick="get_frm_attendence('get_employee_attendance_monthly.php','<?=$date1?>','div_employee_last','<?=$id?>&str7=<?=$shift?>&sdate=<?=$date2?>',document.getElementById('attendace').value,document.getElementById('designation').value,'<?=$type?>')"/>
		</td>
	</tr> 

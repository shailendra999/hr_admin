...
*/					}
 ...
 $sql = "SELECT * FROM ".$mysql_table_prefix."experience_master where emp_id=$emp_experience_edit";
			$result = mysql_query ($sql) or die ("Error in : ".$sql."<br>".mysql_errno()." : ".mysql_error());	
			if(mysql_num_rows($result)>0)
				{	
				$row = mysql_fetch_array($result);
...
$loan ="";*/
			...
			if(isset($_SESSION['emp_assest']))
			{
				...
				$que = mysql_query("SELECT * FROM `assets_detail` where emp_id='$emp_assest_edit'");

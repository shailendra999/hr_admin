<?
	...
	if(isset($_GET['ticket_no']))
	{
		...
		$filter_sql="where ticket_no ='$ticket_no'";
	}
?>
    	...
    	<td align="left" style="padding-top:5px;" colspan="2">
        	<table cellpadding="0" cellspacing="0" border="0" align="left" class="loginbg" width="98%">
                <tr>
                    ...
                    <td width="13%">
                    	<input type="text" id="emp_search" name="emp_search" onkeydown="if(event.keyCode && event.keyCode == 13){get_frm_menu('employee_list_releaved.php',this.value,'emp_list','');}" value="<?=$ticket_no?>"/>
                    </td>

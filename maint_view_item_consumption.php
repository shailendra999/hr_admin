...
<?
$Page = "maint_view_item_consumption.php";
$PageTitle = "View Item Consumption";
	...
	<tr>
        ...
        <tr>
          <td align="center" class="gray_bg">
          	<img src="images/bullet.gif" width="15" height="22"/> &nbsp; View Item Consumption
          </td>
        </tr>
        <tr>
                      ...
                      <td align="center" valign="top" class="border" width="100%" bgcolor="#EAE3E1">
                        <table align="center" width="100%" cellpadding="2" cellspacing="2" border="0" class="text_1">
                          <tr>
                            ...
                            <td width="81%" colspan="3" align="left"><?= $IC_id ?></td>
                          </tr>
                          <tr>
                            <td align="left"><b>Date Of Item Consumption</b></td>
                            <td align="left"><?= $IC_date ?></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                      ...
                      <td>
                        <div id="myDataBaseDiv">
                            ...
                            <tr bgcolor="#eedfdc" class="text_tr">
                              ...
                              <td align="center" style="font-weight:bold;">Cons. Qty</td>
                              <td align="center" style="font-weight:bold;">Stock</td>
                            </tr>
													<?
                          $sql_item_trans="SELECT * 
                          FROM 
                          maint_item_consumption_master mim, 
                          maint_item_consumption_transaction mit 
                          WHERE 
                          mim.IC_id = mit.IC_id AND mit.IC_id ='".$PageKeyValue."' ";
                            ...
                            while($row_i_t=mysql_fetch_array($res_item_trans))
                            {
                              ...
                              ?>
                                  ...
                                  <tr class="text_tr" bgcolor="<?= $tableColor?>">
                                    ...
                                    <td align="center"><?=$row_i_t['cons_qty']?></td>
                                    <td align="center">
                                    <?

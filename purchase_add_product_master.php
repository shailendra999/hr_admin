...
<?
$Page = "purchase_add_product_master.php";
...
if(isset($_POST["btn_submit"]))
{
	...
	$existing_stock = $_POST['existing_stock'];
	$ip_add = $_SERVER['REMOTE_ADDR'];
	if($PageKeyValue == "")
	{
		$tablename="ms_purchase_product_master";
		$tableData=array("''","'$product_name'","'$existing_stock'","now()","$SessionLoginMasterId","'$ip_add'");
	...
	else
	{
		...
		{					
			$tablename="ms_purchase_product_master";
			$tableColumns=array("product_id","product_name","existing_stock");
			$tableData=array("'$PageKeyValue'","'$product_name'","'$existing_stock'");
...
if(isset($_GET[$PageKey]))
{
	...
	if(mysql_num_rows($result)>0)
	{
		...
		$name = $row["name"];	
		$existing_stock = $row["existing_stock"];		
	}
}
?>
                                        ...
                                        <form id="purchase_frm" name="purchase_frm" action="" method="post">
                                            <table align="center" cellpadding="1" cellspacing="1" border="0" width="60%" style="border:#CCCCCC solid 1px;">
                                                <tr>
                                                    ...
                                                    <input type="text" id="product_name" name="product_name" value="<?= $product_name ?>" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="paas_text" bgcolor="#E2EBF0" width="40%" style="padding-left:10px;"><b>Existing Stock</b></td>
                                                    <td align="left" bgcolor="#F2F7F9" width="60%" style="padding-left:10px;">
                                                    <input type="text" id="existing_stock" name="existing_stock" value="<?= $existing_stock ?>" /></td>
                                                </tr>
                                                <tr>

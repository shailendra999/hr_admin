...
if(isset($_POST["btn_del"]))
{
	...
	$sql = "delete from ms_stock_request_master where rec_id = '".$rec_id."'";
	mysql_query ($sql) or die ("Invalid query : ".$sql."<br>".mysql_errno()." : ".mysql_error());
	
	$sql = "delete from ms_stock_request_item_master where request_id = '".$rec_id."'";
	mysql_query ($sql) or die ("Invalid query : ".$sql."<br>".mysql_errno()." : ".mysql_error());
	
	$msg = "Request Sucessfully Deleted";
}	
?>
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;" valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/> &nbsp; List Request Stock</td>
                </tr>
                <?
          			 if(isset($_GET['start']))
                        {
						...
						$sql_prj = "select * from ms_stock_request_master order by insert_date ";
						$query_count = "select count(*) as count from ms_stock_request_master";
                                                ...
                                                <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0" class="tableborder">
                                                            ...
                                                            ?>
                                              				<table align="center" width="100%" border="1" class="table1 text_1">
                                                                <tr>
                                                                  ...
                                                                  <td width="13%" class="gredBg">Empolyee Id</td>
                                                                  <td width="13%"  class="gredBg">Department</td>
                                                                  <td width="13%"  class="gredBg">Plant Id</td>
                                                                  <td width="10%" class="gredBg">Detail</td>
                                                    ...
                                                    ?>
                                                                <tr <? if ($sno%2==1) { ?> bgcolor="#F5F2F1" <? } ?>>
                                                                    ...
                                                                    <td align="center"><?=getemployeeDetailByTicket('first_name',$row['emp_id'])?> <?=getemployeeDetailByTicket('last_name',$row['emp_id'])?></td>
                                                                    <td align="center"><?=getdeptDetail('department_name','rec_id',$row['department'])?></td>
                                                                    <td align="center"><?=getplantDetail('plant_name','rec_id',$row['plant_id'])?></td>
                                                                    <td align="center"><a href="javascript:;" onClick="return hs.htmlExpand(this)">
                                                                        ...
                                                                        <table align="center" width="100%" cellpadding="1" cellspacing="1" border="0">
																			...
																			<?
                                                                                $sql_detail = "select * from ms_stock_request_item_master where request_id = '".$row['rec_id']."'";
                                                                            ...
                                                                            <tr <? if ($s%2==1) { ?> bgcolor="#F5F2F1" <? } ?> class="text_1">
                                                                                <td align="center"><?=$row_detail['item_name']?></td>
                                                                                <td align="center"><?=$row_detail['quantiy']?> <?=$row_detail['quantity_unit']?></td>
                                                                                <td align="center"><?=$row_detail['descriptions']?></td>
                                                                            </tr>
                                                                            <?
                                                                                    $s++;
                                                                                 }

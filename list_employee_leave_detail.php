    	...
    	<td align="left" style="padding-top:5px;" colspan="2">
        	<table cellpadding="0" cellspacing="0" border="0" align="left" class="loginbg" width="98%">
                <tr>
                    ...
                    <td width="13%">
                    	<input type="text" id="emp_search" name="emp_search" onkeyup="get_frm_menu('employee_list_yearly_report.php',this.value,'emp_list','')"/>
                    </td>
                    <td class="text_1" style="padding-top:5px;">
						<form name="frm_check" id="frm_check">
                            <input type="radio" id="search_by" name="search_by" checked="checked" value="Name" onclick="get_frm_menu('employee_list_yearly_report.php',document.getElementById('emp_search').value,'emp_list','')"/>ID
                            <input type="radio" id="search_by" name="search_by" value="ID" onclick="get_frm_menu('employee_list_yearly_report.php',document.getElementById('emp_search').value,'emp_list','')"/>NAME
                        </form>
                    </td>
    ...
    <tr>
        <td align="left" class="menuLink" style="border-right:1px solid #CCCCCC; border-left:1px solid #CCCCCC; padding-top:1px;" width="200px" valign="top">
           ...
           ">
                ...
                $sql_digital = "SELECT mpc_employee_master.*,mpc_account_detail.emp_id,mpc_account_detail.date_releaving FROM mpc_employee_master,mpc_account_detail where mpc_employee_master.rec_id=mpc_account_detail.emp_id and mpc_account_detail.date_releaving ='0000-00-00'";
            ...
            <a href="javascript:;" onclick="get_frm('leave_yearly_detail.php','<?=$row_emp['emp_id']?>','div_detail',document.getElementById('year').value">Yearly Detail</a></div>
            </div>
				<?
                }
                }

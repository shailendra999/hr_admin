    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;"  valign="top">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/> &nbsp; Q.A.</td>
                </tr>
                <tr>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <table width="100%" cellpadding="2" cellspacing="2" align="center" border="0">
                                                    <tr>
                                                        <td class="form_txt border">Mil No.</td>
                                                    ...
                                                    <tr>
                                                        <td class="form_txt border">List of Bales</td>
                                                        <td class="form_txt border" colspan="3" align="left"><div style="text-align:left;">From&nbsp;
                                                        	<input type="text" style="height:20px; width:70px;" />&nbsp;
                                                            to &nbsp;
                                                            <input type="text" style="height:20px; width:70px;" />
                                                            </div>
                                                        </td>

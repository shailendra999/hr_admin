...
if(isset($_GET[$PageKey]))
{
	...
	if(mysql_num_rows($result)>0)
	{
		...
		$supplier_id=$row['supplier_id'];$order_id=$row['order_id'];$indent_id=$row['indent_id'];
	...
	<tr>
		...
		<td style="padding-left:5px; padding-top:5px;" valign="top">
			<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
          	...
          	<img src="images/bullet.gif" width="15" height="22"/> &nbsp; View GRN
          </td>
				</tr>
				<tr>
              ...
              <tr>
                <td class="AddMore">
                   <a target="_blank" href="store_print_GRN.php?GRN_id=<?= $PageKeyValue?>" title="Print">Print&nbsp;&nbsp;&nbsp;</a>
                </td>
              </tr>
							<tr>
                      ...
                      <td align="center" valign="top" class="border" width="100%" bgcolor="#EAE3E1">
                        <table align="center" width="100%" cellpadding="2" cellspacing="2" border="0" class="text_1">
                          ...
                          <tr style="line-height:22px;background:#EAE3E1;">
                              ...
                              <td align="left"><?='<b>'.$indent_id.'</b>'?></td>
                           </tr>
                        </table>
                      </td>
                    </tr>

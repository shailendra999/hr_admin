...
<table width="100%" class="tblborder" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
        ...
        <?
        $sql_order_trans="SELECT * FROM ms_NRGP_master mom, ms_NRGP_Item_transaction mot WHERE mom.NRGP_id = mot.NRGP_id AND mom.NRGP_id ='".$PageKeyValue."'";
        ...
        if($rc_trans>0)
        {
          ...
          <tr class="particulars">
            ...
            <? 
              ...
              $uname='';
							$sql_uom = "SELECT name as uname FROM  ms_uom where uom_id = '".$row_t['uom_id']."' order by name ";

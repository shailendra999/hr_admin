    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px; vertical-align:top">
            <table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
                <tr>
                    <td align="center" class="gray_bg">&nbsp; <a href="#" style="text-decoration:none;color:gray;">Attendence master-> </a>check attendance</td>
                </tr>
                <tr bgcolor="#FFFFFF">
                    <td class="red"></td>
                </tr>
                        ...
                        <form name="frm_import_attendance" id="frm_import_attendance" action="import_attendance.php" method="post" onSubmit="return validate_form(this);">
                            <table width="100%" cellpadding="2" cellspacing="2" border="0" align="center" class="border" style="padding-top:10px; margin-top:10px;">
                                <tr>
                                    ...
                                    <td align="left"><input type="text" name="FromDate" id="FromDate" style="width:150px; height:30px; margin-right: 1%;" value="" data-beatpicker-position="['right','*']" data-beatpicker-format="['DD','MM','YYYY']" data-beatpicker="true"/></td>
                                    <td class="text_1">To Date</td>
                                    <td align="left"><input type="text" name="ToDate" id="ToDate" style="width:150px; height:30px; margin-right: 1%;" value="" data-beatpicker-position="['right','*']" data-beatpicker-format="['DD','MM','YYYY']"  data-beatpicker="true" /></td>
                                    <td>
                            ...
                            <div style="overflow:scroll;height:300px;">
                                <table border="0" align="center" width="100%" style="overflow-y:scroll;" class="border">
                                    <tbody><tr class="blackHead">
                                            ...
                                            <td align="center" width="21%">Attendance Status</td>

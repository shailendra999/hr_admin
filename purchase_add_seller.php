...
if(isset($_POST["btn_submit"]))
{
	...
	else
	{
		...
		{					
			$tablename="ms_seller_master";
			$tableColumns=array("seller_id","name","city");
...
if(isset($_POST["btn_delete"]))
{
	...
	$sql = "delete from ms_seller_master where $PageKey = '".$PageKeyValue."'";
...
{
	$sql = "select * from ms_seller_master where $PageKey = '".$_GET[$PageKey]."'";
    ...
    <tr>
        ...
        <td style="padding-left:5px; padding-top:5px;">
        	<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0">
            	<tr>
                	<td align="center" class="gray_bg"><img src="images/bullet.gif" width="15" height="22"/>&nbsp; Add Seller</td>
                </tr>
                <tr>
                	<td valign="top" style="padding-top:5px; padding-left:40px;">
                    	<table width="1000" align="center" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <div align="center" style="min-height:470px; padding-top:15px;">
                                        ...
                                        <div id="div_category_list"  style="overflow:auto;height:400px;width:750px;margin-top:20px;">
                                          <table align="center" width="100%" style="border:#CCCCCC solid 1px;" cellpadding="2" cellspacing="1">
                                            ...
                                            <?
											$sql = "select * from  ms_seller_master order by name";
											$result = mysql_query ($sql) or die ("Invalid query : ".$sql."<br>".mysql_errno()." : ".mysql_error());
											if(mysql_num_rows($result)>0)
											{
                            ...
                            <td class="Text01"><?=$row["city"]?></td>
														<td class="Text01">
                              <a href="purchase_add_seller.php?seller_id=<?=$row['seller_id']?>&mode=edit">
                              <img src="images/icon_edit.gif" alt="Edit" title="Edit" border="0" />
                              </a>
                            </td>
														<td class="Text01">
                            <a href="javascript:;" onClick="overlay(<?=$row['seller_id']?>);">

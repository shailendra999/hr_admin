<?  ob_start();
	...
	$value = (isset($_POST['str'])) ? $_POST['str'] : "";
...
//echo $val;
	...
	$xlsfile = "Store_Report_Item_Stock_Ledger".date("m-d-Y-hiA").".xls";
...
<table align="center" width="100%" border="1" cellpadding="" class="table1 text_1">
 <caption><?=$company_Fulladdress.'<br /><strong>Item Stock Ledger Report From'.getDateFormate($FromDate).' To '.getDateFormate($ToDate).'</strong>'?></caption>
  <tr>

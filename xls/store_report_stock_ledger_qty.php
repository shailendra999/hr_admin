...
#echo '<pre>';print_r($_POST);echo '<pre>';
	...
	$department_id = ( $_POST["department_id"] != "") ? $department_id = $_POST["department_id"] : $department_id = '';
	$machinary_id = ( $_POST["machinary_id"] != "") ? $machinary_id = $_POST["machinary_id"] : $machinary_id = '';
	$item_id = ( $_POST["item_id"] != "") ? $item_id = $_POST["item_id"] : $item_id = '';
	...
	$xlsfile = "Store_Report_Stock_Ledger_Qty".date("m-d-Y-hiA").".xls";
...
?>
    ...
    <caption><?=$company_Fulladdress.'<strong>Stock Quantity Report Search From '.getDateFormate($FromDate).' To '.getDateFormate($ToDate).'</strong>'?></caption>
                      				<? 
$TotalPurchaseQuantityBetweenDate=0;$TotalIssueQuantityBetweenDate=0;
...
$sql_opening_value="select
	...
	where
		...
		and ms_GRN_master.GRN_date < '".$FromDate."')as OpeningPurchaseQuantity,
	(select
	...
	where
		ms_GRN_master.GRN_id = ms_GRN_transaction.GRN_id
		and ms_GRN_transaction.item_id = im.item_id
		and ms_GRN_master.GRN_date between '".$FromDate."' and '".$ToDate."') as PurchaseQuantityBetweenDate,
		(select
		...
		where
			...
			and ms_IE_master.IE_date < '".$FromDate."') as OpeningIssueQuantity,
			(select 
			...
			where 
				ms_IE_master.IE_id=ms_IE_transaction.IE_id 
				and ms_IE_transaction.item_id=im.item_id 
				and ms_IE_master.IE_date between '".$FromDate."' and '".$ToDate."') as IssueQuantityBetweenDate
from
	ms_item_master im,
	ms_uom
where
	...
	$WhereItem";
                                            ...
                                            if(mysql_num_rows($res_opening_value)>0){
                                                ...
                                                while($row_opening_value=mysql_fetch_array($res_opening_value)){
													...
													$PurchaseQuantityBetweenDate = $row_opening_value["PurchaseQuantityBetweenDate"];
													$IssueQuantityBetweenDate = $row_opening_value["IssueQuantityBetweenDate"];
...
$sql_purchase = "select
	...
	where
		...
		and ms_item_master.item_id='".$row_opening_value['ItemId']."') as OpeningPurchase,
		(select
		...
		where
			...
			and ms_item_master.item_id='".$row_opening_value['ItemId']."') as PurchaseBetweenDates";
                                    ...
                                    <tr>
                                        ...
                                        <td class="gredBg" width="7%">Opening Qty.</td>
                                        <td class="gredBg" width="7%">Purchase Qty.</td>
                                        <td class="gredBg" width="7%">Issue Qty..</td>
                                        
                                        <td class="gredBg" width="7%">Closing Qty.</td>
                                    ...
                                    <trs>
                                        ...
                                        <td width="7%" align="center"><?=$PurchaseQuantityBetweenDate?></td>
                                        <td width="7%" align="center"><?=$IssueQuantityBetweenDate?></td>
                                        <td width="7%" align="center"><?=$sOpeningQuantity+$TodayQuantity?></td>
                                        
                                    </tr>
                                    <? $sno_item++;
										$TotalOpeningQuantity += $sOpeningQuantity;
										$TotalPurchaseQuantityBetweenDate +=$PurchaseQuantityBetweenDate;
										$TotalIssueQuantityBetweenDate +=$IssueQuantityBetweenDate;
                                    ...
                                    <tr bgcolor="#D0C9C1" style="font-size:13px;font-weight:bold;">
                                        ...
                                        <td align="right" style="padding-right:2px">
                                            <?= number_format($TotalPurchaseQuantityBetweenDate,2,'.','')?>
                                        </td>
                                        <td align="right" style="padding-right:2px">
                                            <?= number_format($TotalIssueQuantityBetweenDate,2,'.','')?>
                                        </td>
                                        <td align="right" style="padding-right:2px">

...
'$father_husband_name',
		...
		Username = '$username',Password = '$password',UserType = 'User',IsActive= '1'";
                      ...
                      $sql_insert_personal = "update " . $mysql_table_prefix . "employee_master  set   empType ='$empType',first_name = '$first_name',last_name = '$last_name',
                                        father_husband_name='$father_husband_name',address = '$address',correspondance ='$correspondance',country = '$country',state = '$state',
                                        other_state = '$other_state',city = '$city',other_city = '$other_city',pincode = '$pin_code',dob = '$dob',pob ='$pob',gender = '$gender',
                                        eye ='$eye',illness ='$illness',height ='$height',height_inch='$height_inch',weight ='$weight',phone_no = '$phone_no',mobile_no ='$mobile_no',
                                        emergancy_contact = '$emergancy_contact',email_id = '$email_id',religion='$religion',marital_status = '$marital',marriage_date = '$marr_date',
                                        blood_group = '$blood_group',cast ='$cast',category = '$category',nationality = '$nationality',pan_no='$pan_no',emp_period='$period',	
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td style="vertical-align:top; padding-top:5px;">
                                        ...
                                        <tr>
                                            <td width="100%" colspan="2" align="center"><table cellpadding="0" cellspacing="0" border="0" align="center" class="loginbg">
                                                    <tr>
                                                        ...
                                                        <!--td>
                                                            <input type="radio" name="empType" id="empStaff" value="1" <?php /*
                                  if (@$empType == 'Staff') {
                            ...
                            Advisor/Consultant
                                                        ...
                                                        <td width="4%"></td>
                                                    <label><td><input type="radio" name="period" id="01" value="0" <?php
                                                            if ($period == '0') {
                                                                echo "checked";
                                                            }
                                                            ?> ></td><td width="20%">Probational Period</td></label>
                                                    <label><td><input type="radio" name="period" id="period" value="1" <?php
                                                            if ($period == '1') {
                                                                echo "checked";
                                                            }
                                                            ?> ></td><td>Conform</td></label>
